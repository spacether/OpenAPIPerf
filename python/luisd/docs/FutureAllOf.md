...
**identifiers** | **{str: (str,)}** | External market codes and identifiers for the bond, e.g. ISIN. | 
**contractDetails** | [**FuturesContractDetails**](FuturesContractDetails.md) |  | 
**contracts** | **int, float** | The number of contracts held. | [optional] 
**refSpotPrice** | **int, float** | The reference spot price for the future at which the contract was entered into. | [optional] 
