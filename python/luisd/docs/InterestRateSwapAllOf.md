...
**legs** | **[InstrumentLeg]** | The set of instrument legs that define the swap instrument. | 
**settlementCcy** | **str, none_type** | Settlement currency if IRS is non-deliverable. | [optional] 
