...
**identifiers** | **{str: (str,)}** | external market codes and identifiers for the cds index, e.g. a RED code, BBG ID or ICE code. | 
**basket** | [**Basket**](Basket.md) |  | 
**conventionName** | [**FlowConventionName**](FlowConventionName.md) |  | [optional] 
**notional** | **int, float** | The notional quantity that applies to both the premium and protection legs. | 
