...
**fixingDate** | **datetime** | The date at which the rate to be paid, the reference rate, is confirmed/observed. | 
**fraRate** | **int, float** | The rate at which the FRA is traded. | 
**notional** | **int, float** | The amount for which the FRA is traded. | 
