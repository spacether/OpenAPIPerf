...
class TestConventionsApi(unittest.TestCase):
    """ConventionsApi unit test stubs"""

    def setUp(self):
        self.api = ConventionsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_delete_cds_flow_conventions(self):
        """Test case for delete_cds_flow_conventions
