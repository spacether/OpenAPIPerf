...
import luisd
from luisd.paths.api_complexmarketdata_scope import post  # noqa: E501
from luisd import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiComplexmarketdataScope(ApiTestMixin, unittest.TestCase):
    """
    ApiComplexmarketdataScope unit test stubs
