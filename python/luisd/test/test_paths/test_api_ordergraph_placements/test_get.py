...
import luisd
from luisd.paths.api_ordergraph_placements import get  # noqa: E501
from luisd import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiOrdergraphPlacements(ApiTestMixin, unittest.TestCase):
    """
    ApiOrdergraphPlacements unit test stubs
