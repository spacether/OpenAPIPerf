...
request_query_composite_method = api_client.QueryParameter(
    name="compositeMethod",
    style=api_client.ParameterStyle.FORM,
    schema=CompositeMethodSchema,
    explode=True,
)
...
request_query_output_frequency = api_client.QueryParameter(
    name="outputFrequency",
    style=api_client.ParameterStyle.FORM,
    schema=OutputFrequencySchema,
    explode=True,
)
...
request_query_alternative_inc_date = api_client.QueryParameter(
...
request_path_return_scope = api_client.PathParameter(
    name="returnScope",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReturnScopeSchema,
    required=True,
)
request_path_return_code = api_client.PathParameter(
    name="returnCode",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReturnCodeSchema,
    required=True,
)
_path = '/api/portfolios/{scope}/{code}/returns/{returnScope}/{returnCode}/aggregated'
_method = 'GET'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = ResourceListOfAggregatedReturn
SchemaFor200ResponseBodyApplicationJson = ResourceListOfAggregatedReturn
SchemaFor200ResponseBodyTextJson = ResourceListOfAggregatedReturn
...
class GetPortfolioAggregateReturns(api_client.Api):
    ...
    def get_portfolio_aggregate_returns(
        ...
        for parameter in (
            ...
            request_query_composite_method,
            request_query_period,
            request_query_output_frequency,
