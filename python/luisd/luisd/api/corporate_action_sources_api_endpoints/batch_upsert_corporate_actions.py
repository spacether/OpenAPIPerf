...
request_body_upsert_corporate_action_request = api_client.RequestBody(
    content={
...
_path = '/api/corporateactionsources/{scope}/{code}/corporateactions'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor201ResponseBodyTextPlain = UpsertCorporateActionsResponse
SchemaFor201ResponseBodyApplicationJson = UpsertCorporateActionsResponse
SchemaFor201ResponseBodyTextJson = UpsertCorporateActionsResponse
...
class BatchUpsertCorporateActions(api_client.Api):
