...
_path = '/api/quotes/{scope}/$delete'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = AnnulQuotesResponse
SchemaFor200ResponseBodyApplicationJson = AnnulQuotesResponse
SchemaFor200ResponseBodyTextJson = AnnulQuotesResponse
...
class DeleteQuotes(api_client.Api):
