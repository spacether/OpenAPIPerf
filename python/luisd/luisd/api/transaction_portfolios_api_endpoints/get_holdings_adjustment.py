...
request_path_effective_at = api_client.PathParameter(
    name="effectiveAt",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EffectiveAtSchema,
    required=True,
)
_path = '/api/transactionportfolios/{scope}/{code}/holdingsadjustments/{effectiveAt}'
_method = 'GET'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = HoldingsAdjustment
SchemaFor200ResponseBodyApplicationJson = HoldingsAdjustment
SchemaFor200ResponseBodyTextJson = HoldingsAdjustment
...
class GetHoldingsAdjustment(api_client.Api):
