...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'reconciliationMethods': ReconciliationMethodsSchema,
    },
    total=False
)
...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['AdjustHoldingRequest']:
...
_path = '/api/transactionportfolios/{scope}/{code}/holdings'
_method = 'POST'
_auth = [
    'oauth2',
]
...
class AdjustHoldings(api_client.Api):
