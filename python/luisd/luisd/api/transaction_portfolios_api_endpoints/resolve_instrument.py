...
# query params
InstrumentIdentifierTypeSchema = StrSchema
InstrumentIdentifierValueSchema = StrSchema
...
_path = '/api/transactionportfolios/{scope}/{code}/$resolve'
_method = 'POST'
_auth = [
    'oauth2',
]
...
class ResolveInstrument(api_client.Api):
