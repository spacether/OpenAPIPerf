...
class GroupedResultOfAddressKey(
        ...
        class properties:
            ...
            class values(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AtomValue']:
                        return AtomValue
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["columns"], typing_extensions.Literal["values"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["columns"], typing_extensions.Literal["values"], ]):
