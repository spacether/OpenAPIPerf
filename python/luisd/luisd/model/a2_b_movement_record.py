...
class A2BMovementRecord(
    ...
    @classmethod
    @property
    def portfolioId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    @classmethod
    @property
    def start(cls) -> typing.Type['A2BCategory']:
        return A2BCategory

    @classmethod
    @property
    def flows(cls) -> typing.Type['A2BCategory']:
        return A2BCategory

    @classmethod
    @property
    def gains(cls) -> typing.Type['A2BCategory']:
        return A2BCategory

    @classmethod
    @property
    def carry(cls) -> typing.Type['A2BCategory']:
        return A2BCategory

    @classmethod
    @property
    def end(cls) -> typing.Type['A2BCategory']:
        return A2BCategory
    ...
    class properties(
        ...
        @classmethod
        @property
        def _additional_properties(cls) -> typing.Type['ModelProperty']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        portfolioId: typing.Union['ResourceId', Unset] = unset,
        holdingType: typing.Union[holdingType, Unset] = unset,
        instrumentScope: typing.Union[instrumentScope, Unset] = unset,
        instrumentUid: typing.Union[instrumentUid, Unset] = unset,
        subHoldingKeys: typing.Union[subHoldingKeys, Unset] = unset,
        currency: typing.Union[currency, Unset] = unset,
        transactionId: typing.Union[transactionId, Unset] = unset,
        movementName: typing.Union[movementName, Unset] = unset,
        effectiveDate: typing.Union[effectiveDate, Unset] = unset,
        units: typing.Union[units, Unset] = unset,
        start: typing.Union['A2BCategory', Unset] = unset,
        flows: typing.Union['A2BCategory', Unset] = unset,
        gains: typing.Union['A2BCategory', Unset] = unset,
        carry: typing.Union['A2BCategory', Unset] = unset,
        end: typing.Union['A2BCategory', Unset] = unset,
        properties: typing.Union[properties, Unset] = unset,
        groupId: typing.Union[groupId, Unset] = unset,
        _configuration: typing.Optional[Configuration] = None,
    ) -> 'A2BMovementRecord':
        return super().__new__(
            cls,
