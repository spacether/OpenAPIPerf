...
class UpdateDataTypeRequest(
        ...
        class properties:
            ...
            class acceptableUnits(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UpdateUnitRequest']:
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["acceptableValues"], typing_extensions.Literal["acceptableUnits"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["acceptableValues"], typing_extensions.Literal["acceptableUnits"], ]):
