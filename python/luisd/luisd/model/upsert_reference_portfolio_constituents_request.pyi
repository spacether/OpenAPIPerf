...
class UpsertReferencePortfolioConstituentsRequest(
        ...
        class properties:
            ...
            class constituents(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReferencePortfolioConstituentRequest']:
                        return ReferencePortfolioConstituentRequest
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReferencePortfolioConstituentRequest'], typing.List['ReferencePortfolioConstituentRequest']],
                ...
                def __getitem__(self, i: int) -> 'ReferencePortfolioConstituentRequest':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["weightType"], typing_extensions.Literal["constituents"], typing_extensions.Literal["effectiveFrom"], typing_extensions.Literal["periodType"], typing_extensions.Literal["periodCount"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["weightType"], typing_extensions.Literal["constituents"], typing_extensions.Literal["effectiveFrom"], typing_extensions.Literal["periodType"], typing_extensions.Literal["periodCount"], ]):
