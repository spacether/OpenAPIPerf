...
class GetReferencePortfolioConstituentsResponse(
        ...
        class properties:
            ...
            class constituents(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReferencePortfolioConstituent']:
                        return ReferencePortfolioConstituent
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReferencePortfolioConstituent'], typing.List['ReferencePortfolioConstituent']],
                ...
                def __getitem__(self, i: int) -> 'ReferencePortfolioConstituent':
    ...
    weightType: MetaOapg.properties.weightType
    constituents: MetaOapg.properties.constituents
    effectiveFrom: MetaOapg.properties.effectiveFrom
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["weightType"]) -> MetaOapg.properties.weightType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["constituents"]) -> MetaOapg.properties.constituents: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["weightType"], typing_extensions.Literal["constituents"], typing_extensions.Literal["effectiveFrom"], typing_extensions.Literal["periodType"], typing_extensions.Literal["periodCount"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["weightType"]) -> MetaOapg.properties.weightType: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["constituents"]) -> MetaOapg.properties.constituents: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["periodCount"]) -> typing.Union[MetaOapg.properties.periodCount, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["weightType"], typing_extensions.Literal["constituents"], typing_extensions.Literal["effectiveFrom"], typing_extensions.Literal["periodType"], typing_extensions.Literal["periodCount"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        weightType: typing.Union[MetaOapg.properties.weightType, str, ],
        constituents: typing.Union[MetaOapg.properties.constituents, list, tuple, ],
        effectiveFrom: typing.Union[MetaOapg.properties.effectiveFrom, str, datetime, ],
        periodType: typing.Union[MetaOapg.properties.periodType, None, str, schemas.Unset] = schemas.unset,
        periodCount: typing.Union[MetaOapg.properties.periodCount, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
