...
class CreateCorporateActionSourceRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["scope"], typing_extensions.Literal["description"], typing_extensions.Literal["instrumentScopes"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["scope"], typing_extensions.Literal["description"], typing_extensions.Literal["instrumentScopes"], ]):
