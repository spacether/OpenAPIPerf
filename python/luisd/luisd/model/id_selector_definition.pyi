...
class IdSelectorDefinition(
        ...
        class properties:
            ...
            class actions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ActionId']:
                        return ActionId
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ActionId'], typing.List['ActionId']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'actions':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ActionId':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["identifier"], typing_extensions.Literal["actions"], typing_extensions.Literal["name"], typing_extensions.Literal["description"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["identifier"], typing_extensions.Literal["actions"], typing_extensions.Literal["name"], typing_extensions.Literal["description"], ]):
        return super().get_item_oapg(name)
