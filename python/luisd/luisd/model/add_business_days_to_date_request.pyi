...
class AddBusinessDaysToDateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            businessDayOffset = schemas.Int32Schema
    ...
    businessDayOffset: MetaOapg.properties.businessDayOffset
    holidayCodes: MetaOapg.properties.holidayCodes
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["businessDayOffset"]) -> MetaOapg.properties.businessDayOffset: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["holidayCodes"]) -> MetaOapg.properties.holidayCodes: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["businessDayOffset"], typing_extensions.Literal["holidayCodes"], typing_extensions.Literal["startDate"], typing_extensions.Literal["asAt"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["businessDayOffset"]) -> MetaOapg.properties.businessDayOffset: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["holidayCodes"]) -> MetaOapg.properties.holidayCodes: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["businessDayOffset"], typing_extensions.Literal["holidayCodes"], typing_extensions.Literal["startDate"], typing_extensions.Literal["asAt"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        businessDayOffset: typing.Union[MetaOapg.properties.businessDayOffset, decimal.Decimal, int, ],
        holidayCodes: typing.Union[MetaOapg.properties.holidayCodes, list, tuple, ],
