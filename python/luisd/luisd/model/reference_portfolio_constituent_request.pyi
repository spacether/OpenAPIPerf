...
class ReferencePortfolioConstituentRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["weight"], typing_extensions.Literal["instrumentIdentifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["currency"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["weight"], typing_extensions.Literal["instrumentIdentifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["currency"], ]):
        return super().get_item_oapg(name)
