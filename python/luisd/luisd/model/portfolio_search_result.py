...
class PortfolioSearchResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created"], typing_extensions.Literal["displayName"], typing_extensions.Literal["id"], typing_extensions.Literal["type"], typing_extensions.Literal["href"], typing_extensions.Literal["description"], typing_extensions.Literal["isDerived"], typing_extensions.Literal["parentPortfolioId"], typing_extensions.Literal["baseCurrency"], typing_extensions.Literal["properties"], typing_extensions.Literal["links"], ]):
