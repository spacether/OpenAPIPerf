...
class UpdateRelationshipDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["outwardDescription"], typing_extensions.Literal["displayName"], typing_extensions.Literal["inwardDescription"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["outwardDescription"], typing_extensions.Literal["displayName"], typing_extensions.Literal["inwardDescription"], ]):
