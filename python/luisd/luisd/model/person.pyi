...
class Person(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lusidPersonId"]) -> MetaOapg.properties.lusidPersonId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["href"], typing_extensions.Literal["lusidPersonId"], typing_extensions.Literal["identifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["version"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lusidPersonId"]) -> typing.Union[MetaOapg.properties.lusidPersonId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["href"], typing_extensions.Literal["lusidPersonId"], typing_extensions.Literal["identifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["version"], ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        lusidPersonId: typing.Union[MetaOapg.properties.lusidPersonId, None, str, schemas.Unset] = schemas.unset,
