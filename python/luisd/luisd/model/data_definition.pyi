...
one or more of the items in the dictionary would make it unique. If only a single item is required then the
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["keyType"]) -> MetaOapg.properties.keyType: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address"], typing_extensions.Literal["name"], typing_extensions.Literal["dataType"], typing_extensions.Literal["keyType"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["keyType"]) -> typing.Union[MetaOapg.properties.keyType, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address"], typing_extensions.Literal["name"], typing_extensions.Literal["dataType"], typing_extensions.Literal["keyType"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        dataType: typing.Union[MetaOapg.properties.dataType, None, str, schemas.Unset] = schemas.unset,
        keyType: typing.Union[MetaOapg.properties.keyType, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'DataDefinition':
        return super().__new__(
            cls,
