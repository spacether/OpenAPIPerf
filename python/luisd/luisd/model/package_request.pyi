...
class PackageRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["orderInstructionIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orderIds"], typing_extensions.Literal["properties"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["orderInstructionIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orderIds"], typing_extensions.Literal["properties"], ]):
        return super().get_item_oapg(name)
