...
class CreateSequenceRequest(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        code: code,
        increment: typing.Union[increment, Unset] = unset,
        minValue: typing.Union[minValue, Unset] = unset,
        maxValue: typing.Union[maxValue, Unset] = unset,
        start: typing.Union[start, Unset] = unset,
        cycle: typing.Union[cycle, Unset] = unset,
