...
class CreateSequenceRequest(
        ...
        class properties:
            ...
            class pattern(
                ...
                class MetaOapg:
                    ...
                    min_length = 1
                    regex=[{
                        'pattern': r'^[A-Za-z0-9_-]*\{\{seqValue\}\}[A-Za-z0-9_-]*$',  # noqa: E501
                    }]
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["increment"], typing_extensions.Literal["minValue"], typing_extensions.Literal["maxValue"], typing_extensions.Literal["start"], typing_extensions.Literal["cycle"], typing_extensions.Literal["pattern"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["increment"], typing_extensions.Literal["minValue"], typing_extensions.Literal["maxValue"], typing_extensions.Literal["start"], typing_extensions.Literal["cycle"], typing_extensions.Literal["pattern"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        increment: typing.Union[MetaOapg.properties.increment, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        minValue: typing.Union[MetaOapg.properties.minValue, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        maxValue: typing.Union[MetaOapg.properties.maxValue, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        start: typing.Union[MetaOapg.properties.start, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        cycle: typing.Union[MetaOapg.properties.cycle, bool, schemas.Unset] = schemas.unset,
