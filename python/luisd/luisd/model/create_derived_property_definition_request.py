...
class CreateDerivedPropertyDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["domain"], typing_extensions.Literal["scope"], typing_extensions.Literal["dataTypeId"], typing_extensions.Literal["propertyDescription"], typing_extensions.Literal["derivationFormula"], ]):
