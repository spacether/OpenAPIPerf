...
class VirtualDocumentRow(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def rowData() -> typing.Type['GroupedResultOfAddressKey']:
                return GroupedResultOfAddressKey
            __annotations__ = {
                "rowId": rowId,
                "rowData": rowData,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rowData"]) -> 'GroupedResultOfAddressKey': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rowId"], typing_extensions.Literal["rowData"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rowData"]) -> typing.Union['GroupedResultOfAddressKey', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rowId"], typing_extensions.Literal["rowData"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        rowId: typing.Union[MetaOapg.properties.rowId, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        rowData: typing.Union['GroupedResultOfAddressKey', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'VirtualDocumentRow':
        return super().__new__(
            cls,
