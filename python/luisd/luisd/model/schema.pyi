...
class Schema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entity"], typing_extensions.Literal["href"], typing_extensions.Literal["values"], typing_extensions.Literal["links"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entity"], typing_extensions.Literal["href"], typing_extensions.Literal["values"], typing_extensions.Literal["links"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        entity: typing.Union[MetaOapg.properties.entity, None, str, schemas.Unset] = schemas.unset,
