...
class Change(
    ...
    @classmethod
    @property
    def entityId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    corrected = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        correctionEffectiveAt: typing.Union[correctionEffectiveAt, Unset] = unset,
        correctionAsAt: typing.Union[correctionAsAt, Unset] = unset,
        amendmentEffectiveAt: typing.Union[amendmentEffectiveAt, Unset] = unset,
        amendmentAsAt: typing.Union[amendmentAsAt, Unset] = unset,
