...
class Instrument(
    ...
    @classmethod
    @property
    def lookthroughPortfolio(cls) -> typing.Type['ResourceId']:
        return ResourceId

    @classmethod
    @property
    def instrumentDefinition(cls) -> typing.Type['LusidInstrument']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        lookthroughPortfolio: typing.Union['ResourceId', Unset] = unset,
        instrumentDefinition: typing.Union['LusidInstrument', Unset] = unset,
