...
class A2BBreakdown(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total"], typing_extensions.Literal["currency"], typing_extensions.Literal["components"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total"], typing_extensions.Literal["currency"], typing_extensions.Literal["components"], ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        components: typing.Union[MetaOapg.properties.components, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'A2BBreakdown':
        return super().__new__(
            cls,
