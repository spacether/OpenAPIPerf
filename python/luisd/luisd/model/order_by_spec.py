...
class OrderBySpec(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sortOrder"], typing_extensions.Literal["key"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sortOrder"], typing_extensions.Literal["key"], ]):
