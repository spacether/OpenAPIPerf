...
class DeleteInstrumentPropertiesResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asAt"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asAt"], typing_extensions.Literal["links"], ]):
