...
class UpsertLegalEntityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["identifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["description"], typing_extensions.Literal["counterpartyRiskInformation"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["identifiers"], typing_extensions.Literal["properties"], typing_extensions.Literal["description"], typing_extensions.Literal["counterpartyRiskInformation"], ]):
        return super().get_item_oapg(name)
