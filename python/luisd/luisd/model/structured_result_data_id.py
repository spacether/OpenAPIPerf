...
class StructuredResultDataId(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resultType"]) -> MetaOapg.properties.resultType: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source"], typing_extensions.Literal["code"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["resultType"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resultType"]) -> typing.Union[MetaOapg.properties.resultType, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source"], typing_extensions.Literal["code"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["resultType"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        resultType: typing.Union[MetaOapg.properties.resultType, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
