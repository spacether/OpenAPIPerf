...
class AccessMetadataValue(
    ...
    An access control value. Provider should only be used if you are a service provide licensing data. In that case
the provider value must match your domain.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value"], typing_extensions.Literal["provider"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value"], typing_extensions.Literal["provider"], ]):
