...
class SideConfigurationData(
    ...
    Configuration needed to define a side. Sides are referenced by Label. Beyond that, other properties
can be used to reference either transaction fields, or transaction properties.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["security"], typing_extensions.Literal["side"], typing_extensions.Literal["rate"], typing_extensions.Literal["currency"], typing_extensions.Literal["units"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["security"], typing_extensions.Literal["side"], typing_extensions.Literal["rate"], typing_extensions.Literal["currency"], typing_extensions.Literal["units"], typing_extensions.Literal["links"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        rate: typing.Union[MetaOapg.properties.rate, str, ],
