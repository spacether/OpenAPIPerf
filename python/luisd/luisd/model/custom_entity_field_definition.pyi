...
class CustomEntityFieldDefinition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lifetime"], typing_extensions.Literal["name"], typing_extensions.Literal["type"], typing_extensions.Literal["required"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lifetime"], typing_extensions.Literal["name"], typing_extensions.Literal["type"], typing_extensions.Literal["required"], ]):
