...
class WeightedInstrument(
    ...
    @classmethod
    @property
    def instrument(cls) -> typing.Type['LusidInstrument']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        holdingIdentifier: typing.Union[holdingIdentifier, Unset] = unset,
        instrument: typing.Union['LusidInstrument', Unset] = unset,
        _configuration: typing.Optional[Configuration] = None,
    ) -> 'WeightedInstrument':
        return super().__new__(
            cls,
