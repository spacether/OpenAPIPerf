...
class LusidInstrument(
    ...
    Base class in hierarchy for LUSID Instruments. Valuation would normally be performed through passing LUSID a Code for a portfolio to be valued.
...
value the inlined set. This the base instrument for this case.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["instrumentType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instrumentType"], ]):
