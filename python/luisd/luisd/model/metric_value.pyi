...
class MetricValue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value"], typing_extensions.Literal["unit"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value"], typing_extensions.Literal["unit"], ]):
