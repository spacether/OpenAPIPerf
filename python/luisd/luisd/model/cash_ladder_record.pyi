...
class CashLadderRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["activities"], typing_extensions.Literal["close"], typing_extensions.Literal["open"], typing_extensions.Literal["effectiveDate"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["activities"], typing_extensions.Literal["close"], typing_extensions.Literal["open"], typing_extensions.Literal["effectiveDate"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        activities: typing.Union[MetaOapg.properties.activities, dict, frozendict.frozendict, ],
