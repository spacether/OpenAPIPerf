...
class ComplexMarketData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["marketDataType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["marketDataType"], ]):
