...
class ExecutionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["side"], typing_extensions.Literal["createdDate"], typing_extensions.Literal["quantity"], typing_extensions.Literal["settlementCurrency"], typing_extensions.Literal["placementId"], typing_extensions.Literal["price"], typing_extensions.Literal["settlementCurrencyFxRate"], typing_extensions.Literal["counterparty"], typing_extensions.Literal["instrumentIdentifiers"], typing_extensions.Literal["id"], typing_extensions.Literal["state"], typing_extensions.Literal["type"], typing_extensions.Literal["properties"], typing_extensions.Literal["settlementDate"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
