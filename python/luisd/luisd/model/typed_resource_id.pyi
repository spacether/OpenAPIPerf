...
class TypedResourceId(
    ...
    Represents the user-defined identifier for a Legal Entity or Person.
...
when used to identify a Person, the identifier defined by Person/myScope/username would be represented as
 {
   ...
   "code": "john_doe_001"
    ...
    idTypeScope: MetaOapg.properties.idTypeScope
    idTypeCode: MetaOapg.properties.idTypeCode
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["code"]) -> MetaOapg.properties.code: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["idTypeScope"]) -> MetaOapg.properties.idTypeScope: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["idTypeCode"]) -> MetaOapg.properties.idTypeCode: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["idTypeScope"], typing_extensions.Literal["idTypeCode"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["idTypeScope"]) -> MetaOapg.properties.idTypeScope: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["idTypeCode"]) -> MetaOapg.properties.idTypeCode: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["idTypeScope"], typing_extensions.Literal["idTypeCode"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        idTypeScope: typing.Union[MetaOapg.properties.idTypeScope, str, ],
        idTypeCode: typing.Union[MetaOapg.properties.idTypeCode, str, ],
