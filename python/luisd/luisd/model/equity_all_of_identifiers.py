...
class EquityAllOfIdentifiers(
    ...
    Sedol = StrSchema
    Cusip = StrSchema
    ClientInternal = StrSchema
    Figi = StrSchema
    RIC = StrSchema
    QuotePermId = StrSchema
    REDCode = StrSchema
    BBGId = StrSchema
    ICECode = StrSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        LusidInstrumentId: typing.Union[LusidInstrumentId, Unset] = unset,
        Isin: typing.Union[Isin, Unset] = unset,
        Sedol: typing.Union[Sedol, Unset] = unset,
        Cusip: typing.Union[Cusip, Unset] = unset,
        ClientInternal: typing.Union[ClientInternal, Unset] = unset,
        Figi: typing.Union[Figi, Unset] = unset,
        RIC: typing.Union[RIC, Unset] = unset,
        QuotePermId: typing.Union[QuotePermId, Unset] = unset,
