...
class ComplianceRuleResult(
    ...
    ruleId = StrSchema
    ruleName = StrSchema
    ruleDescription = StrSchema

    @classmethod
    @property
    def portfolio(cls) -> typing.Type['ResourceId']:
        return ResourceId
    passed = BoolSchema
    resultValue = Float64Schema
    ruleInformationMatch = StrSchema
    ruleInformationKey = StrSchema
    ruleLowerLimit = Int32Schema
    ruleUpperLimit = Int32Schema
