...
class ConfigurationRecipeSnippet(
    ...
    If it is desired to have multiple recipes, there is a strong likelihood that they will share various components.
...
to ensure that pricing is performed consistently and provide an audit of changes made to it along with restricting changes to appropriate authorised functions.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def aggregationOptions() -> typing.Type['AggregationOptions']:
            ...
            class modelRules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['VendorModelRule']:
                        return VendorModelRule
            ...
            @staticmethod
            def pricingOptions() -> typing.Type['PricingOptions']:
            ...
            @staticmethod
            def marketOptions() -> typing.Type['MarketOptions']:
                return MarketOptions
        
            @staticmethod
            def recipe() -> typing.Type['ConfigurationRecipe']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aggregationOptions"]) -> 'AggregationOptions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["modelRules"]) -> MetaOapg.properties.modelRules: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pricingOptions"]) -> 'PricingOptions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["marketRules"]) -> MetaOapg.properties.marketRules: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["marketOptions"]) -> 'MarketOptions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["recipe"]) -> 'ConfigurationRecipe': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["scope"], typing_extensions.Literal["aggregationOptions"], typing_extensions.Literal["modelRules"], typing_extensions.Literal["pricingOptions"], typing_extensions.Literal["marketRules"], typing_extensions.Literal["marketOptions"], typing_extensions.Literal["recipe"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aggregationOptions"]) -> typing.Union['AggregationOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["modelRules"]) -> typing.Union[MetaOapg.properties.modelRules, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pricingOptions"]) -> typing.Union['PricingOptions', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["marketOptions"]) -> typing.Union['MarketOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["recipe"]) -> typing.Union['ConfigurationRecipe', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        aggregationOptions: typing.Union['AggregationOptions', schemas.Unset] = schemas.unset,
        modelRules: typing.Union[MetaOapg.properties.modelRules, list, tuple, None, schemas.Unset] = schemas.unset,
        pricingOptions: typing.Union['PricingOptions', schemas.Unset] = schemas.unset,
        marketRules: typing.Union[MetaOapg.properties.marketRules, list, tuple, None, schemas.Unset] = schemas.unset,
        marketOptions: typing.Union['MarketOptions', schemas.Unset] = schemas.unset,
        recipe: typing.Union['ConfigurationRecipe', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
