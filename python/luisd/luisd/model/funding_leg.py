...
class FundingLeg(
    ...
    IL FundingLeg Instrument; Lusid-ibor internal representation of a funding leg with variable notional.
...
The main analytic calculated for this instrument is Accrual rather than PV.
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legDefinition", "notional", "instrumentType", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legDefinition", "notional", "instrumentType", ], str]):
