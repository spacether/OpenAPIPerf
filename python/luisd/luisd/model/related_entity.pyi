...
class RelatedEntity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityType"], typing_extensions.Literal["entityId"], typing_extensions.Literal["properties"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityType"], typing_extensions.Literal["entityId"], typing_extensions.Literal["properties"], ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        entityId: typing.Union[MetaOapg.properties.entityId, dict, frozendict.frozendict, ],
