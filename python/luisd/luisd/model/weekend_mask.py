...
class WeekendMask(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class days(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DayOfWeek'], typing.List['DayOfWeek']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["days"], typing_extensions.Literal["timeZone"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["days"], typing_extensions.Literal["timeZone"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        days: typing.Union[MetaOapg.properties.days, list, tuple, ],
