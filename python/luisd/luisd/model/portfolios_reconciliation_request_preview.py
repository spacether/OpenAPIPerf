...
class PortfoliosReconciliationRequestPreview(
    ...
    class tolerance(
        ...
        @classmethod
        @property
        def _additional_properties(cls) -> typing.Type['Tolerance']:
            return Tolerance
    ...
    @classmethod
    @property
    def left(cls) -> typing.Type['PortfolioReconciliationRequest']:
        return PortfolioReconciliationRequest

    @classmethod
    @property
    def right(cls) -> typing.Type['PortfolioReconciliationRequest']:
        return PortfolioReconciliationRequest
