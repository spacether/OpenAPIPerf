...
class TranslateInstrumentDefinitionsRequest(
    ...
    dialect: MetaOapg.properties.dialect
    instruments: MetaOapg.properties.instruments
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dialect"]) -> MetaOapg.properties.dialect: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["instruments"]) -> MetaOapg.properties.instruments: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dialect"], typing_extensions.Literal["instruments"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dialect"]) -> MetaOapg.properties.dialect: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["instruments"]) -> MetaOapg.properties.instruments: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dialect"], typing_extensions.Literal["instruments"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        dialect: typing.Union[MetaOapg.properties.dialect, str, ],
        instruments: typing.Union[MetaOapg.properties.instruments, dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
