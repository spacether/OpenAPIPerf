...
class ResultDataSchema(
    ...
    class nodeValueSchema(
        ...
        @classmethod
        @property
        def _additional_properties(cls) -> typing.Type['FieldSchema']:
            return FieldSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        nodeValueSchema: typing.Union[nodeValueSchema, Unset] = unset,
        propertySchema: typing.Union[propertySchema, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'ResultDataSchema':
        return super().__new__(
            cls,
