...
of outstanding orders at a given time.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["side"], typing_extensions.Literal["createdDate"], typing_extensions.Literal["quantity"], typing_extensions.Literal["instrumentIdentifiers"], typing_extensions.Literal["id"], typing_extensions.Literal["orderIds"], typing_extensions.Literal["type"], typing_extensions.Literal["lusidInstrumentId"], typing_extensions.Literal["timeInForce"], typing_extensions.Literal["properties"], typing_extensions.Literal["limitPrice"], typing_extensions.Literal["stopPrice"], typing_extensions.Literal["version"], typing_extensions.Literal["links"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
