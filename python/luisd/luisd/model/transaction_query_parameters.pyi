...
class TransactionQueryParameters(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            showCancelledTransactions = schemas.BoolSchema
            __annotations__ = {
                "startDate": startDate,
                "endDate": endDate,
                "queryMode": queryMode,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["queryMode"]) -> MetaOapg.properties.queryMode: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["showCancelledTransactions"]) -> MetaOapg.properties.showCancelledTransactions: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endDate"], typing_extensions.Literal["startDate"], typing_extensions.Literal["queryMode"], typing_extensions.Literal["showCancelledTransactions"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["queryMode"]) -> typing.Union[MetaOapg.properties.queryMode, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["showCancelledTransactions"]) -> typing.Union[MetaOapg.properties.showCancelledTransactions, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endDate"], typing_extensions.Literal["startDate"], typing_extensions.Literal["queryMode"], typing_extensions.Literal["showCancelledTransactions"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        queryMode: typing.Union[MetaOapg.properties.queryMode, str, schemas.Unset] = schemas.unset,
        showCancelledTransactions: typing.Union[MetaOapg.properties.showCancelledTransactions, bool, schemas.Unset] = schemas.unset,
