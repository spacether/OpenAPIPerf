...
class ExoticInstrument(
    ...
    Class modeling an instrument which is not fully described, in the sense of being able to obtain a price or other analytic result,
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def instrumentFormat() -> typing.Type['InstrumentDefinitionFormat']:
                        return InstrumentDefinitionFormat
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["instrumentFormat"]) -> 'InstrumentDefinitionFormat': ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["instrumentFormat", "content", "instrumentType", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["instrumentFormat"]) -> 'InstrumentDefinitionFormat': ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instrumentFormat", "content", "instrumentType", ], str]):
