...
class Link(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["method"], typing_extensions.Literal["href"], typing_extensions.Literal["relation"], typing_extensions.Literal["description"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["method"], typing_extensions.Literal["href"], typing_extensions.Literal["relation"], typing_extensions.Literal["description"], ]):
