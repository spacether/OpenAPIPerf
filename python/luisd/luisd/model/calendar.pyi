...
class Calendar(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def weekendMask() -> typing.Type['WeekendMask']:
                return WeekendMask
            sourceProvider = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceProvider"], typing_extensions.Literal["weekendMask"], typing_extensions.Literal["id"], typing_extensions.Literal["type"], typing_extensions.Literal["properties"], typing_extensions.Literal["href"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceProvider"], typing_extensions.Literal["weekendMask"], typing_extensions.Literal["id"], typing_extensions.Literal["type"], typing_extensions.Literal["properties"], typing_extensions.Literal["href"], ]):
