...
class CreateDerivedTransactionPortfolioRequest(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parentPortfolioId"]) -> 'ResourceId': ...
