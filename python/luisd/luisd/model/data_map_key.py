...
class DataMapKey(
        ...
        class properties:
            ...
            class version(
                ...
                class MetaOapg:
                    ...
                    min_length = 0
                    regex=[{
                        'pattern': r'^\d+\.\d+(\.)?\d+(-[a-zA-Z0-9\.-]{1,30})?$',  # noqa: E501
                    }]
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version"], typing_extensions.Literal["code"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version"], typing_extensions.Literal["code"], ]):
