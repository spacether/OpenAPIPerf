...
class ErrorDetail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["type"], typing_extensions.Literal["detail"], typing_extensions.Literal["errorDetails"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["type"], typing_extensions.Literal["detail"], typing_extensions.Literal["errorDetails"], ]):
        return super().get_item_oapg(name)
