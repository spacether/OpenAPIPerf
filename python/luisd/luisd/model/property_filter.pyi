...
class PropertyFilter(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rightOperandType"]) -> MetaOapg.properties.rightOperandType: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["left"], typing_extensions.Literal["operator"], typing_extensions.Literal["right"], typing_extensions.Literal["rightOperandType"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rightOperandType"]) -> typing.Union[MetaOapg.properties.rightOperandType, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["left"], typing_extensions.Literal["operator"], typing_extensions.Literal["right"], typing_extensions.Literal["rightOperandType"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        right: typing.Union[MetaOapg.properties.right, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        rightOperandType: typing.Union[MetaOapg.properties.rightOperandType, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PropertyFilter':
        return super().__new__(
            cls,
