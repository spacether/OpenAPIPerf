...
class Quote(
    ...
    @classmethod
    @property
    def quoteId(cls) -> typing.Type['QuoteId']:
        return QuoteId
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        lineage: typing.Union[lineage, Unset] = unset,
        cutLabel: typing.Union[cutLabel, Unset] = unset,
        scaleFactor: typing.Union[scaleFactor, Unset] = unset,
        _configuration: typing.Optional[Configuration] = None,
    ) -> 'Quote':
        return super().__new__(
            cls,
