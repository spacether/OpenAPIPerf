...
class ReconciliationBreak(
    ...
    leftUnits = Float64Schema
    rightUnits = Float64Schema
    differenceUnits = Float64Schema

    @classmethod
    @property
    def leftCost(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def rightCost(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def differenceCost(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount
    ...
    class instrumentProperties(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['ModelProperty']:
