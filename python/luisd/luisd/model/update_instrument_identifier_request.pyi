...
class UpdateInstrumentIdentifierRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type"], typing_extensions.Literal["value"], typing_extensions.Literal["effectiveAt"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type"], typing_extensions.Literal["value"], typing_extensions.Literal["effectiveAt"], ]):
