...
In particular,
the scope that the data was stored in,
and a <seealso cref="T:Finbourne.WebApi.Interface.Dto.ComplexMarketData.ComplexMarketDataId" /> object identifying the market data in that scope.
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def marketDataId() -> typing.Type['ComplexMarketDataId']:
                return ComplexMarketDataId
        
            @staticmethod
            def marketData() -> typing.Type['ComplexMarketData']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["marketDataId"]) -> 'ComplexMarketDataId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["marketData"]) -> 'ComplexMarketData': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["scope"], typing_extensions.Literal["marketDataId"], typing_extensions.Literal["marketData"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["marketDataId"]) -> typing.Union['ComplexMarketDataId', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["marketData"]) -> typing.Union['ComplexMarketData', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["scope"], typing_extensions.Literal["marketDataId"], typing_extensions.Literal["marketData"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        marketDataId: typing.Union['ComplexMarketDataId', schemas.Unset] = schemas.unset,
        marketData: typing.Union['ComplexMarketData', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
