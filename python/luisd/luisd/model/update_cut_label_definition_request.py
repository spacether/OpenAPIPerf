...
class UpdateCutLabelDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["timeZone"], typing_extensions.Literal["cutLocalTime"], typing_extensions.Literal["description"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["timeZone"], typing_extensions.Literal["cutLocalTime"], typing_extensions.Literal["description"], ]):
