...
class OrderGraphBlock(
    ...
    @classmethod
    @property
    def block(cls) -> typing.Type['Block']:
        return Block
    ...
    @classmethod
    @property
    def ordered(cls) -> typing.Type['OrderGraphSynopsis']:
        return OrderGraphSynopsis

    @classmethod
    @property
    def placed(cls) -> typing.Type['OrderGraphSynopsis']:
        return OrderGraphSynopsis

    @classmethod
    @property
    def executed(cls) -> typing.Type['OrderGraphSynopsis']:
        return OrderGraphSynopsis

    @classmethod
    @property
    def allocated(cls) -> typing.Type['OrderGraphSynopsis']:
        return OrderGraphSynopsis
    derivedState = StrSchema
