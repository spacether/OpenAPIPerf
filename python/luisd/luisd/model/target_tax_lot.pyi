...
class TargetTaxLot(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["portfolioCost"]) -> MetaOapg.properties.portfolioCost: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["units"], typing_extensions.Literal["cost"], typing_extensions.Literal["portfolioCost"], typing_extensions.Literal["price"], typing_extensions.Literal["purchaseDate"], typing_extensions.Literal["settlementDate"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cost"]) -> typing.Union['CurrencyAndAmount', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["portfolioCost"]) -> typing.Union[MetaOapg.properties.portfolioCost, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["units"], typing_extensions.Literal["cost"], typing_extensions.Literal["portfolioCost"], typing_extensions.Literal["price"], typing_extensions.Literal["purchaseDate"], typing_extensions.Literal["settlementDate"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        cost: typing.Union['CurrencyAndAmount', schemas.Unset] = schemas.unset,
        portfolioCost: typing.Union[MetaOapg.properties.portfolioCost, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        price: typing.Union[MetaOapg.properties.price, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        purchaseDate: typing.Union[MetaOapg.properties.purchaseDate, None, str, datetime, schemas.Unset] = schemas.unset,
        settlementDate: typing.Union[MetaOapg.properties.settlementDate, None, str, datetime, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TargetTaxLot':
        return super().__new__(
            cls,
