...
class ModelSelection(
    ...
    The combination of a library to use and a model in that library that defines which pricing code will evaluate instruments
having a particular type/class. This allows us to control the model type and library for a given instrument.
    ...
    library: MetaOapg.properties.library
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["library"], typing_extensions.Literal["model"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["library"]) -> MetaOapg.properties.library: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["model"]) -> MetaOapg.properties.model: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["library"], typing_extensions.Literal["model"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        library: typing.Union[MetaOapg.properties.library, str, ],
