...
class PortfolioDetails(
    ...
    @classmethod
    @property
    def originPortfolioId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    def version(cls) -> typing.Type['Version']:
        return Version
    baseCurrency = StrSchema

    @classmethod
    @property
    def corporateActionSourceId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        corporateActionSourceId: typing.Union['ResourceId', Unset] = unset,
