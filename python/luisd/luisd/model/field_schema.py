...
class FieldSchema(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            displayOrder = schemas.Int32Schema
            __annotations__ = {
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["type"], typing_extensions.Literal["displayOrder"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["type"], typing_extensions.Literal["displayOrder"], ]):
