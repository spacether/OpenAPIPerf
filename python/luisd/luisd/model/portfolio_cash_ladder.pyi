...
class PortfolioCashLadder(
        ...
        class properties:
            ...
            class records(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CashLadderRecord']:
                        return CashLadderRecord
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CashLadderRecord'], typing.List['CashLadderRecord']],
                ...
                def __getitem__(self, i: int) -> 'CashLadderRecord':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["records"], typing_extensions.Literal["currency"], typing_extensions.Literal["subHoldingKeys"], typing_extensions.Literal["links"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["records"], typing_extensions.Literal["currency"], typing_extensions.Literal["subHoldingKeys"], typing_extensions.Literal["links"], ]):
        return super().get_item_oapg(name)
