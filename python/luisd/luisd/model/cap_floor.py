...
Collar Type: Strategy of buying one Cap and selling one Floor where FloorStrike is less than CapStrike.
    ...
    def _composed_schemas(cls):
        ...
        class allOf_1(
            ...
            capFloorType = StrSchema
            capStrike = Float64Schema
            floorStrike = Float64Schema
            includeFirstCaplet = BoolSchema
        
            @classmethod
            @property
            def underlyingFloatingLeg(cls) -> typing.Type['FloatingLeg']:
                return FloatingLeg
