...
class UpdateCalendarRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceProvider"], typing_extensions.Literal["weekendMask"], typing_extensions.Literal["properties"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceProvider"], typing_extensions.Literal["weekendMask"], typing_extensions.Literal["properties"], ]):
