...
The data map object is designed to allow data to transition from step 1 to 2 and in some cases as an alternative for step 2 to 3.
        ...
        class properties:
            ...
            class dataDefinitions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataDefinition']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dataDefinitions"]) -> MetaOapg.properties.dataDefinitions: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataDefinitions"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dataDefinitions"]) -> typing.Union[MetaOapg.properties.dataDefinitions, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataDefinitions"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        dataDefinitions: typing.Union[MetaOapg.properties.dataDefinitions, list, tuple, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'DataMapping':
        return super().__new__(
            cls,
