...
class CrossCurrencySwap(
    ...
    IL Cross Currency Swap Instrument; Lusid-ibor internal representation of a Cross Currency Swap instrument
...
payment currency, payment frequency and so on they can be used to match sets of future obligations
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legs", "instrumentType", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legs", "instrumentType", ], str]):
