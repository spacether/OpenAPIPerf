...
class WeightedInstruments(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["instruments"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instruments"], ]):
