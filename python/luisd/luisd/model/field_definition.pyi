...
class FieldDefinition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isRequired"], typing_extensions.Literal["isUnique"], typing_extensions.Literal["key"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isRequired"], typing_extensions.Literal["isUnique"], typing_extensions.Literal["key"], ]):
