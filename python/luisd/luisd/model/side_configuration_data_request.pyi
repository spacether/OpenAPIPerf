...
can be used to reference either transaction fields, or transaction properties.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["security"], typing_extensions.Literal["side"], typing_extensions.Literal["rate"], typing_extensions.Literal["currency"], typing_extensions.Literal["units"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["security"], typing_extensions.Literal["side"], typing_extensions.Literal["rate"], typing_extensions.Literal["currency"], typing_extensions.Literal["units"], ]):
