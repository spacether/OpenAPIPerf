...
class UpsertCdsFlowConventionsRequest(
    ...
    CDS Flow convention that is to be stored in the convention data store.
Only one of these must be present.
    """

    @classmethod
    @property
    def cdsFlowConventions(cls) -> typing.Type['CdsFlowConventions']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        cdsFlowConventions: typing.Union['CdsFlowConventions', Unset] = unset,
