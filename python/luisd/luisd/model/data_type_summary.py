...
class DataTypeSummary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["valueType"], typing_extensions.Literal["description"], typing_extensions.Literal["id"], typing_extensions.Literal["typeValueRange"], typing_extensions.Literal["acceptableValues"], typing_extensions.Literal["unitSchema"], typing_extensions.Literal["acceptableUnits"], ]):
