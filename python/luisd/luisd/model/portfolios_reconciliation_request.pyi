...
class PortfoliosReconciliationRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["left"], typing_extensions.Literal["instrumentPropertyKeys"], typing_extensions.Literal["right"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["left"], typing_extensions.Literal["instrumentPropertyKeys"], typing_extensions.Literal["right"], ]):
