...
class FxForwardCurveByQuoteReference(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            quoteReferences: MetaOapg.properties.quoteReferences
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["quoteReferences"]) -> MetaOapg.properties.quoteReferences: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["domCcy", "fgnCcy", "tenors", "quoteReferences", "marketDataType", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["quoteReferences"]) -> MetaOapg.properties.quoteReferences: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domCcy", "fgnCcy", "tenors", "quoteReferences", "marketDataType", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                quoteReferences: typing.Union[MetaOapg.properties.quoteReferences, list, tuple, ],
                _configuration: typing.Optional[schemas.Configuration] = None,
