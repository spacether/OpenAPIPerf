...
class Premium(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date"], typing_extensions.Literal["amount"], typing_extensions.Literal["currency"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date"], typing_extensions.Literal["amount"], typing_extensions.Literal["currency"], ]):
