...
class AggregationOptions(
    ...
    """
    useAnsiLikeSyntax = BoolSchema
    allowPartialEntitlementSuccess = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        useAnsiLikeSyntax: typing.Union[useAnsiLikeSyntax, Unset] = unset,
        allowPartialEntitlementSuccess: typing.Union[allowPartialEntitlementSuccess, Unset] = unset,
