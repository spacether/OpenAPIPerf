...
class ModelOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["modelOptionsType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["modelOptionsType"], ]):
