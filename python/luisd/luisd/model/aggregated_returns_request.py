...
class AggregatedReturnsRequest(
    ...
    class metrics(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['PerformanceReturnsMetric']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        compositeMethod: typing.Union[compositeMethod, Unset] = unset,
        period: typing.Union[period, Unset] = unset,
        outputFrequency: typing.Union[outputFrequency, Unset] = unset,
        alternativeInceptionDate: typing.Union[alternativeInceptionDate, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
