...
class ReconciliationRule(
    ...
    A rule describing how a comparison between two items in the reconciliation should be performed and what constitutes equality.
...
If a rule is not given for an item, it will default to equality comparison.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ruleType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ruleType"], ]):
