...
class IdentifierPartSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["name"], typing_extensions.Literal["description"], typing_extensions.Literal["index"], typing_extensions.Literal["required"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["name"], typing_extensions.Literal["description"], typing_extensions.Literal["index"], typing_extensions.Literal["required"], typing_extensions.Literal["links"], ]):
