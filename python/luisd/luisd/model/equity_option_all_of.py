...
class EquityOptionAllOf(
    ...
    optionMaturityDate = DateTimeSchema
    optionSettlementDate = DateTimeSchema
    ...
    class deliveryType(
        ...
        @property
        def CASH(cls):
            return cls._enum_by_value["Cash"]("Cash")
        
        @classmethod
        @property
        def PHYSICAL(cls):
            return cls._enum_by_value["Physical"]("Physical")
    ...
    class optionType(
        ...
        @property
        def CALL(cls):
            return cls._enum_by_value["Call"]("Call")
        
        @classmethod
        @property
        def PUT(cls):
            return cls._enum_by_value["Put"]("Put")
