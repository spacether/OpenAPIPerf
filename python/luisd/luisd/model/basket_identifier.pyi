...
class BasketIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["index"], typing_extensions.Literal["region"], typing_extensions.Literal["seriesId"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["index"], typing_extensions.Literal["region"], typing_extensions.Literal["seriesId"], ]):
