...
class UpsertQuoteRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["quoteId"], typing_extensions.Literal["metricValue"], typing_extensions.Literal["lineage"], typing_extensions.Literal["scaleFactor"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["quoteId"], typing_extensions.Literal["metricValue"], typing_extensions.Literal["lineage"], typing_extensions.Literal["scaleFactor"], ]):
