...
class CreatePortfolioGroupRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["created"], typing_extensions.Literal["values"], typing_extensions.Literal["subGroups"], typing_extensions.Literal["properties"], typing_extensions.Literal["description"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["created"], typing_extensions.Literal["values"], typing_extensions.Literal["subGroups"], typing_extensions.Literal["properties"], typing_extensions.Literal["description"], ]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        values: typing.Union[MetaOapg.properties.values, list, tuple, None, schemas.Unset] = schemas.unset,
        subGroups: typing.Union[MetaOapg.properties.subGroups, list, tuple, None, schemas.Unset] = schemas.unset,
