        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def legDefinition() -> typing.Type['LegDefinition']:
                    ...
                    class overrides(
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["Amortization"]) -> MetaOapg.properties.Amortization: ...
                        
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["Spreads"]) -> MetaOapg.properties.Spreads: ...
                        
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["Amortization"], typing_extensions.Literal["Spreads"], ]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["Amortization"]) -> typing.Union[MetaOapg.properties.Amortization, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["Spreads"]) -> typing.Union[MetaOapg.properties.Spreads, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Amortization"], typing_extensions.Literal["Spreads"], ]):
                            return super().get_item_oapg(name)
                    
                        def __new__(
                            cls,
                            *args: typing.Union[dict, frozendict.frozendict, None, ],
                            Amortization: typing.Union[MetaOapg.properties.Amortization, list, tuple, schemas.Unset] = schemas.unset,
                            Spreads: typing.Union[MetaOapg.properties.Spreads, list, tuple, schemas.Unset] = schemas.unset,
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'overrides':
                            return super().__new__(
                                cls,
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["legDefinition"]) -> 'LegDefinition': ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legDefinition", "notional", "overrides", "instrumentType", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["legDefinition"]) -> 'LegDefinition': ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "legDefinition", "notional", "overrides", "instrumentType", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                overrides: typing.Union[MetaOapg.properties.overrides, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
