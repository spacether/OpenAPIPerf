...
class Package(
    ...
    orderInstructionIds: MetaOapg.properties.orderInstructionIds
    id: 'ResourceId'
    orderIds: MetaOapg.properties.orderIds
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["orderInstructionIds"]) -> MetaOapg.properties.orderInstructionIds: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["orderInstructionIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orderIds"], typing_extensions.Literal["properties"], typing_extensions.Literal["version"], typing_extensions.Literal["links"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["orderInstructionIds"]) -> MetaOapg.properties.orderInstructionIds: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["orderInstructionIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orderIds"], typing_extensions.Literal["properties"], typing_extensions.Literal["version"], typing_extensions.Literal["links"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        orderInstructionIds: typing.Union[MetaOapg.properties.orderInstructionIds, list, tuple, ],
        id: 'ResourceId',
