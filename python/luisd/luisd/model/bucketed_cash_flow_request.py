...
class BucketedCashFlowRequest(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        bucketingDates: typing.Union[bucketingDates, Unset] = unset,
        bucketTenors: typing.Union[bucketTenors, Unset] = unset,
        effectiveAt: typing.Union[effectiveAt, Unset] = unset,
        windowStart: typing.Union[windowStart, Unset] = unset,
        windowEnd: typing.Union[windowEnd, Unset] = unset,
