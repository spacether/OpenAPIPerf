...
class CreateRelationshipRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["targetEntityId"], typing_extensions.Literal["sourceEntityId"], typing_extensions.Literal["effectiveFrom"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["targetEntityId"], typing_extensions.Literal["sourceEntityId"], typing_extensions.Literal["effectiveFrom"], ]):
        return super().get_item_oapg(name)
