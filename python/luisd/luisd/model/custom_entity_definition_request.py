...
class CustomEntityDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityTypeName"], typing_extensions.Literal["description"], typing_extensions.Literal["fieldSchema"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldSchema"]) -> typing.Union[MetaOapg.properties.fieldSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityTypeName"], typing_extensions.Literal["description"], typing_extensions.Literal["fieldSchema"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fieldSchema: typing.Union[MetaOapg.properties.fieldSchema, list, tuple, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
