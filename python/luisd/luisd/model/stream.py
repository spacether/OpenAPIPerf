...
class Stream(
    ...
    canRead = BoolSchema
    canSeek = BoolSchema
    canTimeout = BoolSchema
    canWrite = BoolSchema
    length = Int64Schema
    position = Int64Schema
    readTimeout = Int32Schema
    writeTimeout = Int32Schema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        canRead: typing.Union[canRead, Unset] = unset,
        canSeek: typing.Union[canSeek, Unset] = unset,
        canTimeout: typing.Union[canTimeout, Unset] = unset,
        canWrite: typing.Union[canWrite, Unset] = unset,
        length: typing.Union[length, Unset] = unset,
        position: typing.Union[position, Unset] = unset,
        readTimeout: typing.Union[readTimeout, Unset] = unset,
        writeTimeout: typing.Union[writeTimeout, Unset] = unset,
