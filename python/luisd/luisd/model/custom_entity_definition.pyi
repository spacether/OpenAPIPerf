...
class CustomEntityDefinition(
    ...
    class MetaOapg:
        ...
        class properties:
            entityTypeName = schemas.StrSchema
            ...
            class fieldSchema(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CustomEntityFieldDefinition']:
                        return CustomEntityFieldDefinition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CustomEntityFieldDefinition'], typing.List['CustomEntityFieldDefinition']],
                ...
                def __getitem__(self, i: int) -> 'CustomEntityFieldDefinition':
    ...
    entityTypeName: MetaOapg.properties.entityTypeName
    fieldSchema: MetaOapg.properties.fieldSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fieldSchema"]) -> MetaOapg.properties.fieldSchema: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityType"], typing_extensions.Literal["entityTypeName"], typing_extensions.Literal["fieldSchema"], typing_extensions.Literal["href"], typing_extensions.Literal["description"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["entityTypeName"]) -> MetaOapg.properties.entityTypeName: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldSchema"]) -> MetaOapg.properties.fieldSchema: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["entityType"], typing_extensions.Literal["entityTypeName"], typing_extensions.Literal["fieldSchema"], typing_extensions.Literal["href"], typing_extensions.Literal["description"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        entityTypeName: typing.Union[MetaOapg.properties.entityTypeName, str, ],
        fieldSchema: typing.Union[MetaOapg.properties.fieldSchema, list, tuple, ],
