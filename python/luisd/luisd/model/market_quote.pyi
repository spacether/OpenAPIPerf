...
remove lineage, price source etc. for ease of use when creating complex market data.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["quoteType"], typing_extensions.Literal["value"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["quoteType"], typing_extensions.Literal["value"], ]):
