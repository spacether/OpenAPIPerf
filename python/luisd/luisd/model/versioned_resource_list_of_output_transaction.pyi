...
class VersionedResourceListOfOutputTransaction(
        ...
        class properties:
            ...
            class values(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OutputTransaction']:
                        return OutputTransaction
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OutputTransaction'], typing.List['OutputTransaction']],
                ...
                def __getitem__(self, i: int) -> 'OutputTransaction':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], typing_extensions.Literal["links"], ]):
