...
class ActionId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["activity"], typing_extensions.Literal["scope"], typing_extensions.Literal["entity"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["activity"], typing_extensions.Literal["scope"], typing_extensions.Literal["entity"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        activity: typing.Union[MetaOapg.properties.activity, str, ],
