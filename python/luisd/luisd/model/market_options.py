...
per source. Be aware that where no specified rule matches the final fallback is on to the logic implied here.
    ...
    class defaultScope(
        ...
        pass
    attemptToInferMissingFx = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        defaultSupplier: typing.Union[defaultSupplier, Unset] = unset,
        defaultInstrumentCodeType: typing.Union[defaultInstrumentCodeType, Unset] = unset,
