...
class VersionedResourceListWithWarningsOfPortfolioHolding(
        ...
        class properties:
            ...
            class values(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PortfolioHolding']:
                        return PortfolioHolding
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PortfolioHolding'], typing.List['PortfolioHolding']],
                ...
                def __getitem__(self, i: int) -> 'PortfolioHolding':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], typing_extensions.Literal["warnings"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], typing_extensions.Literal["warnings"], typing_extensions.Literal["links"], ]):
