...
class ResourceListOfListComplexMarketDataWithMetaDataResponse(
        ...
        class properties:
            ...
            class values(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ListComplexMarketDataWithMetaDataResponse']:
                        return ListComplexMarketDataWithMetaDataResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ListComplexMarketDataWithMetaDataResponse'], typing.List['ListComplexMarketDataWithMetaDataResponse']],
                ...
                def __getitem__(self, i: int) -> 'ListComplexMarketDataWithMetaDataResponse':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["values"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], typing_extensions.Literal["nextPage"], typing_extensions.Literal["previousPage"], ]):
