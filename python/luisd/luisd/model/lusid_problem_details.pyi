...
class LusidProblemDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["name"], typing_extensions.Literal["errorDetails"], typing_extensions.Literal["type"], typing_extensions.Literal["title"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], typing_extensions.Literal["extensions"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
