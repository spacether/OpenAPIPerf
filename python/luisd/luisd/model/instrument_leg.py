...
A set of cashflows that are paid at a set of points in time according to some set of conventions.
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["instrumentType", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instrumentType", ], str]):
