...
class UpsertInstrumentPropertyRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["identifier"], typing_extensions.Literal["identifierType"], typing_extensions.Literal["properties"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["identifier"], typing_extensions.Literal["identifierType"], typing_extensions.Literal["properties"], ]):
