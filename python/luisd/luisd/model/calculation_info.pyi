...
class CalculationInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            calculationDescription = schemas.StrSchema
            ...
            class multiplier(
                ...
                def VALUE(cls):
                    return cls("Value")
            calculationAmount = schemas.Float64Schema
            __annotations__ = {
    ...
    calculationMethod: MetaOapg.properties.calculationMethod
    multiplier: MetaOapg.properties.multiplier
    calculationDescription: MetaOapg.properties.calculationDescription
    calculationAmount: MetaOapg.properties.calculationAmount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["calculationDescription"]) -> MetaOapg.properties.calculationDescription: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["calculationAmount"]) -> MetaOapg.properties.calculationAmount: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["calculationMethod"], typing_extensions.Literal["multiplier"], typing_extensions.Literal["calculationDescription"], typing_extensions.Literal["calculationAmount"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["calculationMethod"]) -> MetaOapg.properties.calculationMethod: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["multiplier"]) -> MetaOapg.properties.multiplier: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["calculationDescription"]) -> MetaOapg.properties.calculationDescription: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["calculationAmount"]) -> MetaOapg.properties.calculationAmount: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["calculationMethod"], typing_extensions.Literal["multiplier"], typing_extensions.Literal["calculationDescription"], typing_extensions.Literal["calculationAmount"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        calculationMethod: typing.Union[MetaOapg.properties.calculationMethod, str, ],
        multiplier: typing.Union[MetaOapg.properties.multiplier, str, ],
        calculationDescription: typing.Union[MetaOapg.properties.calculationDescription, str, ],
        calculationAmount: typing.Union[MetaOapg.properties.calculationAmount, decimal.Decimal, int, float, ],
