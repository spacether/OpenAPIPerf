...
class PortfolioReconciliationRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["portfolioId"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["asAt"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["portfolioId"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["asAt"], ]):
