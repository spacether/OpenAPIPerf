...
class AdjustHolding(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version"], typing_extensions.Literal["href"], typing_extensions.Literal["links"], ]):
