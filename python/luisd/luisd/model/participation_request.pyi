...
class ParticipationRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["placementId"], typing_extensions.Literal["orderId"], typing_extensions.Literal["id"], typing_extensions.Literal["version"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["placementId"], typing_extensions.Literal["orderId"], typing_extensions.Literal["id"], typing_extensions.Literal["version"], ]):
