...
class CreatePropertyDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["domain"], typing_extensions.Literal["scope"], typing_extensions.Literal["dataTypeId"], typing_extensions.Literal["valueRequired"], typing_extensions.Literal["lifeTime"], typing_extensions.Literal["constraintStyle"], typing_extensions.Literal["propertyDescription"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dataTypeId"]) -> 'ResourceId': ...
