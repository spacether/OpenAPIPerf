...
class PropertyInterval(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["effectiveRange"], typing_extensions.Literal["asAtRange"], typing_extensions.Literal["value"], typing_extensions.Literal["status"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["value"]) -> 'PropertyValue': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> MetaOapg.properties.status: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["effectiveRange"], typing_extensions.Literal["asAtRange"], typing_extensions.Literal["value"], typing_extensions.Literal["status"], ]):
