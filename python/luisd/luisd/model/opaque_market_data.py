...
class OpaqueMarketData(
    ...
    A representation of an un-built piece of complex market data, to allow for passing through
...
The market data will usually be in some standard form such as XML or Json, representing a curve or surface.
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["document", "format", "name", "marketDataType", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["document", "format", "name", "marketDataType", ], str]):
