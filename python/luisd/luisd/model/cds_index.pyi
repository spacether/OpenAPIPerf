...
class CdsIndex(
    ...
    IL CDS Index Instrument; Lusid-ibor internal representation of a Credit Default Swap Index instrument
Calculation information and reference data can be obtained from Markit, e.g. https://www.markit.com/Documentation/Product/ITraxx
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            notional: MetaOapg.properties.notional
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["basket"]) -> 'Basket': ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "basket", "conventionName", "notional", "instrumentType", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["basket"]) -> 'Basket': ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["conventionName"]) -> typing.Union['FlowConventionName', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["notional"]) -> MetaOapg.properties.notional: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "basket", "conventionName", "notional", "instrumentType", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                notional: typing.Union[MetaOapg.properties.notional, decimal.Decimal, int, float, ],
