...
class TransactionPropertyMapping(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mapFrom"]) -> MetaOapg.properties.mapFrom: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["setTo"]) -> MetaOapg.properties.setTo: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["propertyKey"], typing_extensions.Literal["mapFrom"], typing_extensions.Literal["setTo"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mapFrom"]) -> typing.Union[MetaOapg.properties.mapFrom, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["setTo"]) -> typing.Union[MetaOapg.properties.setTo, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["propertyKey"], typing_extensions.Literal["mapFrom"], typing_extensions.Literal["setTo"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        mapFrom: typing.Union[MetaOapg.properties.mapFrom, None, str, schemas.Unset] = schemas.unset,
        setTo: typing.Union[MetaOapg.properties.setTo, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
