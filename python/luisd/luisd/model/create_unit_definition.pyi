...
class CreateUnitDefinition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["details"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["details"], ]):
        return super().get_item_oapg(name)
