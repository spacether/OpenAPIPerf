...
class CreateReferencePortfolioRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["created"], typing_extensions.Literal["properties"], typing_extensions.Literal["instrumentScopes"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], typing_extensions.Literal["created"], typing_extensions.Literal["properties"], typing_extensions.Literal["instrumentScopes"], ]):
        return super().get_item_oapg(name)
