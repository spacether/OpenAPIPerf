...
class CreateCutLabelDefinitionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["timeZone"], typing_extensions.Literal["cutLocalTime"], typing_extensions.Literal["description"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cutLocalTime"]) -> 'CutLocalTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["description"]) -> typing.Union[MetaOapg.properties.description, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["timeZone"], typing_extensions.Literal["cutLocalTime"], typing_extensions.Literal["description"], ]):
