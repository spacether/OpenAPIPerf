...
class MarketDataKeyRule(
    ...
    A market data key rule describes a mapping for satisfying a particular market dependency. The supplier, scope, quote type and price side
...
specifics required to uniquely describe a specific economic entity (e.g. an Fx currency pair, equity name or credit curve).
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["field"], typing_extensions.Literal["supplier"], typing_extensions.Literal["dataScope"], typing_extensions.Literal["quoteType"], typing_extensions.Literal["key"], typing_extensions.Literal["quoteInterval"], typing_extensions.Literal["asAt"], typing_extensions.Literal["priceSource"], typing_extensions.Literal["mask"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        quoteType: typing.Union[MetaOapg.properties.quoteType, str, ],
