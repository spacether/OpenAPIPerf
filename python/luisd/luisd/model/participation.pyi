...
class Participation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def orderId() -> typing.Type['ResourceId']:
                return ResourceId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["orderId"]) -> 'ResourceId': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["placementId"], typing_extensions.Literal["orderId"], typing_extensions.Literal["id"], typing_extensions.Literal["version"], typing_extensions.Literal["links"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["orderId"]) -> 'ResourceId': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["placementId"], typing_extensions.Literal["orderId"], typing_extensions.Literal["id"], typing_extensions.Literal["version"], typing_extensions.Literal["links"], ]):
