...
class IUnitDefinitionDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["schema"], typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["schema"], typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["description"], ]):
