...
methodology or system.
    ...
    @classmethod
    @property
    def left(cls) -> typing.Type['ValuationRequest']:
        return ValuationRequest

    @classmethod
    @property
    def right(cls) -> typing.Type['ValuationRequest']:
        return ValuationRequest
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        left: left,
        right: right,
        leftToRightMapping: typing.Union[leftToRightMapping, Unset] = unset,
        comparisonRules: typing.Union[comparisonRules, Unset] = unset,
        preserveKeys: typing.Union[preserveKeys, Unset] = unset,
        _configuration: typing.Optional[Configuration] = None,
