...
class ComplexMarketDataId(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["marketAsset"]) -> MetaOapg.properties.marketAsset: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["provider"], typing_extensions.Literal["priceSource"], typing_extensions.Literal["lineage"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["marketAsset"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["marketAsset"]) -> typing.Union[MetaOapg.properties.marketAsset, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["provider"], typing_extensions.Literal["priceSource"], typing_extensions.Literal["lineage"], typing_extensions.Literal["effectiveAt"], typing_extensions.Literal["marketAsset"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        marketAsset: typing.Union[MetaOapg.properties.marketAsset, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ComplexMarketDataId':
        return super().__new__(
            cls,
