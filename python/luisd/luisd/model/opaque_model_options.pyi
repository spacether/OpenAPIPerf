...
class OpaqueModelOptions(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "modelOptionsType", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "modelOptionsType", ], str]):
                return super().get_item_oapg(name)
