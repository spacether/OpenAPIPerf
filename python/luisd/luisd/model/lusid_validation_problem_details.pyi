...
class LusidValidationProblemDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["name"], typing_extensions.Literal["errorDetails"], typing_extensions.Literal["errors"], typing_extensions.Literal["type"], typing_extensions.Literal["title"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], typing_extensions.Literal["extensions"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        errorDetails: typing.Union[MetaOapg.properties.errorDetails, list, tuple, None, schemas.Unset] = schemas.unset,
        errors: typing.Union[MetaOapg.properties.errors, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
