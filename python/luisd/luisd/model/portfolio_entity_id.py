...
class PortfolioEntityId(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["portfolioEntityType"]) -> MetaOapg.properties.portfolioEntityType: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["scope"], typing_extensions.Literal["code"], typing_extensions.Literal["portfolioEntityType"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["portfolioEntityType"]) -> typing.Union[MetaOapg.properties.portfolioEntityType, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["scope"], typing_extensions.Literal["code"], typing_extensions.Literal["portfolioEntityType"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        portfolioEntityType: typing.Union[MetaOapg.properties.portfolioEntityType, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PortfolioEntityId':
        return super().__new__(
            cls,
