...
contracts of a certain size at a date in the future.
    ...
    def _composed_schemas(cls):
        ...
        class allOf_1(
            ...
            @classmethod
            @property
            def contractDetails(cls) -> typing.Type['FuturesContractDetails']:
                return FuturesContractDetails
            contracts = Float64Schema
            refSpotPrice = Float64Schema
        
            @classmethod
            @property
            def underlying(cls) -> typing.Type['LusidInstrument']:
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict, ],
                ...
                contracts: typing.Union[contracts, Unset] = unset,
                refSpotPrice: typing.Union[refSpotPrice, Unset] = unset,
                _configuration: typing.Optional[Configuration] = None,
                **kwargs: typing.Type[Schema],
            ) -> 'allOf_1':
                return super().__new__(
