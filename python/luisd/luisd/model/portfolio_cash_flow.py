...
class PortfolioCashFlow(
    ...
    groupById = Int32Schema
    sequenceNumber = Int32Schema
    ...
    type = StrSchema
    movementName = StrSchema

    @classmethod
    @property
    def cashflow(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def balance(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount
    fxRate = Float64Schema

    @classmethod
    @property
    def cashflowReportingCurrency(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def balanceReportingCurrency(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def translationGainLoss(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def costBasisReportingCurrency(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def transaction(cls) -> typing.Type['Transaction']:
        return Transaction

    @classmethod
    @property
    def unrealisedGainLossReportingCurrency(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        transaction: typing.Union['Transaction', Unset] = unset,
