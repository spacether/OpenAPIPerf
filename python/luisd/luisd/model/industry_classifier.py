...
which comprises a classification code and the name of the classification system to which the code belongs.
    ...
    class MetaOapg:
        ...
        class properties:
            classificationSystemName = schemas.StrSchema
    ...
    classificationCode: MetaOapg.properties.classificationCode
    classificationSystemName: MetaOapg.properties.classificationSystemName
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["classificationCode"]) -> MetaOapg.properties.classificationCode: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["classificationSystemName"]) -> MetaOapg.properties.classificationSystemName: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["classificationCode"], typing_extensions.Literal["classificationSystemName"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["classificationCode"]) -> MetaOapg.properties.classificationCode: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["classificationSystemName"]) -> MetaOapg.properties.classificationSystemName: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["classificationCode"], typing_extensions.Literal["classificationSystemName"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, ],
        classificationCode: typing.Union[MetaOapg.properties.classificationCode, str, ],
        classificationSystemName: typing.Union[MetaOapg.properties.classificationSystemName, str, ],
