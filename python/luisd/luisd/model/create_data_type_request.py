...
class CreateDataTypeRequest(
        ...
        class properties:
            ...
            class acceptableUnits(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CreateUnitDefinition']:
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code"], typing_extensions.Literal["displayName"], typing_extensions.Literal["scope"], typing_extensions.Literal["valueType"], typing_extensions.Literal["description"], typing_extensions.Literal["typeValueRange"], typing_extensions.Literal["acceptableValues"], typing_extensions.Literal["unitSchema"], typing_extensions.Literal["acceptableUnits"], typing_extensions.Literal["referenceData"], ]):
