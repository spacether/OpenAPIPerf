...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TransactionRequest']:
            return TransactionRequest

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TransactionRequest'], typing.List['TransactionRequest']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'TransactionRequest':
...
class UpsertTransactions(BaseApi):
    ...
    def upsert_transactions(
        ...
        return self._upsert_transactions_oapg(
            body=body,
