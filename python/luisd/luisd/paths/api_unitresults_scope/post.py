...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    @classmethod
    @property
    def _additional_properties(cls) -> typing.Type['UpsertStructuredResultDataRequest']:
...
class BaseApi(api_client.Api):
    ...
    def _upsert_structured_result_data(
        self: api_client.Api,
...
class UpsertStructuredResultData(BaseApi):
    ...
    def upsert_structured_result_data(
        ...
        return self._upsert_structured_result_data(
            body=body,
