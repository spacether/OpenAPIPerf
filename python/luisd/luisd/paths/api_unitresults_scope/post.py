...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['UpsertStructuredResultDataRequest']:
            return UpsertStructuredResultDataRequest
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'UpsertStructuredResultDataRequest':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'UpsertStructuredResultDataRequest':
    ...
    def __new__(
        ...
        **kwargs: 'UpsertStructuredResultDataRequest',
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_structured_result_data_oapg(
        self,
...
class UpsertStructuredResultData(BaseApi):
    ...
    def upsert_structured_result_data(
        ...
        return self._upsert_structured_result_data_oapg(
            body=body,
