...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = BlockSetRequest
SchemaForRequestBodyApplicationJson = BlockSetRequest
SchemaForRequestBodyTextJson = BlockSetRequest
SchemaForRequestBodyApplicationJson = BlockSetRequest


request_body_block_set_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = ResourceListOfBlock
SchemaFor201ResponseBodyApplicationJson = ResourceListOfBlock
SchemaFor201ResponseBodyTextJson = ResourceListOfBlock
...
class BaseApi(api_client.Api):
    ...
    def _upsert_blocks_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_block_set_request.serialize(body, content_type)
...
class UpsertBlocks(BaseApi):
    ...
    def upsert_blocks(
        ...
        return self._upsert_blocks_oapg(
            body=body,
