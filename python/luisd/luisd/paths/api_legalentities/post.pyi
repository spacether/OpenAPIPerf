...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = UpsertLegalEntityRequest
SchemaForRequestBodyApplicationJson = UpsertLegalEntityRequest
SchemaForRequestBodyTextJson = UpsertLegalEntityRequest
SchemaForRequestBodyApplicationJson = UpsertLegalEntityRequest


request_body_upsert_legal_entity_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = LegalEntity
SchemaFor201ResponseBodyApplicationJson = LegalEntity
SchemaFor201ResponseBodyTextJson = LegalEntity
...
class BaseApi(api_client.Api):
    ...
    def _upsert_legal_entity_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upsert_legal_entity_request.serialize(body, content_type)
...
class UpsertLegalEntity(BaseApi):
    ...
    def upsert_legal_entity(
        ...
        return self._upsert_legal_entity_oapg(
            body=body,
