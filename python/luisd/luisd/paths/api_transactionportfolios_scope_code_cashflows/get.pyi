...
SchemaFor200ResponseBodyTextPlain = ResourceListOfInstrumentCashFlow
SchemaFor200ResponseBodyApplicationJson = ResourceListOfInstrumentCashFlow
SchemaFor200ResponseBodyTextJson = ResourceListOfInstrumentCashFlow
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_cash_flows_oapg(
        self,
...
class GetPortfolioCashFlows(BaseApi):
    ...
    def get_portfolio_cash_flows(
        ...
        return self._get_portfolio_cash_flows_oapg(
