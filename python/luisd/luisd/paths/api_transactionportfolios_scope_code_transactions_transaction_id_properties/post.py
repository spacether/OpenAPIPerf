...
SchemaFor200ResponseBodyTextPlain = UpsertTransactionPropertiesResponse
SchemaFor200ResponseBodyApplicationJson = UpsertTransactionPropertiesResponse
SchemaFor200ResponseBodyTextJson = UpsertTransactionPropertiesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_transaction_properties_oapg(
        self,
...
class UpsertTransactionProperties(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upsert_transaction_properties(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson,dict, frozendict.frozendict, ],
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def upsert_transaction_properties(
        ...
        return self._upsert_transaction_properties_oapg(
            body=body,
