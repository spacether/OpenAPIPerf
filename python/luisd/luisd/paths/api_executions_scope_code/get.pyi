...
SchemaFor200ResponseBodyTextPlain = Execution
SchemaFor200ResponseBodyApplicationJson = Execution
SchemaFor200ResponseBodyTextJson = Execution
...
class GetExecution(BaseApi):
    ...
    def get_execution(
        ...
        return self._get_execution_oapg(
