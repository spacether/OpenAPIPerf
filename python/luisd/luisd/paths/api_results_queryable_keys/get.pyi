...
SchemaFor200ResponseBodyTextPlain = ResourceListOfAggregationQuery
SchemaFor200ResponseBodyApplicationJson = ResourceListOfAggregationQuery
SchemaFor200ResponseBodyTextJson = ResourceListOfAggregationQuery
...
class GetQueryableKeys(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_queryable_keys(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_queryable_keys(
        ...
        return self._get_queryable_keys_oapg(
