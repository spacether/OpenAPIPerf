...
class FromTransactionDateSchema(
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fromTransactionDate': typing.Union[FromTransactionDateSchema, None, str, ],
        'toTransactionDate': typing.Union[ToTransactionDateSchema, None, str, ],
...
request_query_from_transaction_date = api_client.QueryParameter(
    name="fromTransactionDate",
    style=api_client.ParameterStyle.FORM,
    schema=FromTransactionDateSchema,
    explode=True,
)
request_query_to_transaction_date = api_client.QueryParameter(
    name="toTransactionDate",
    style=api_client.ParameterStyle.FORM,
    schema=ToTransactionDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = VersionedResourceListOfTransaction
SchemaFor200ResponseBodyApplicationJson = VersionedResourceListOfTransaction
SchemaFor200ResponseBodyTextJson = VersionedResourceListOfTransaction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transactions_for_portfolio_group_oapg(
        self,
    ...
    def _get_transactions_for_portfolio_group_oapg(
        ...
        for parameter in (
            request_query_from_transaction_date,
            request_query_to_transaction_date,
            request_query_as_at,
...
class GetTransactionsForPortfolioGroup(BaseApi):
    ...
    def get_transactions_for_portfolio_group(
        ...
        return self._get_transactions_for_portfolio_group_oapg(
