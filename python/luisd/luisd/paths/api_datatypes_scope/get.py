...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeSystem': typing.Union[IncludeSystemSchema, None, bool, ],
...
request_query_include_system = api_client.QueryParameter(
    name="includeSystem",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeSystemSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfDataType
SchemaFor200ResponseBodyApplicationJson = ResourceListOfDataType
SchemaFor200ResponseBodyTextJson = ResourceListOfDataType
...
class ListDataTypes(BaseApi):
    ...
    def list_data_types(
        ...
        return self._list_data_types_oapg(
