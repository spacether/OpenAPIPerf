...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = TransactionConfigurationDataRequest
SchemaForRequestBodyApplicationJson = TransactionConfigurationDataRequest
SchemaForRequestBodyTextJson = TransactionConfigurationDataRequest
SchemaForRequestBodyApplicationJson = TransactionConfigurationDataRequest


request_body_transaction_configuration_data_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = TransactionSetConfigurationData
SchemaFor201ResponseBodyApplicationJson = TransactionSetConfigurationData
SchemaFor201ResponseBodyTextJson = TransactionSetConfigurationData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_configuration_transaction_type_oapg(
        self,
    ...
    def _create_configuration_transaction_type_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_transaction_configuration_data_request.serialize(body, content_type)
...
class CreateConfigurationTransactionType(BaseApi):
    ...
    def create_configuration_transaction_type(
        ...
        return self._create_configuration_transaction_type_oapg(
            body=body,
