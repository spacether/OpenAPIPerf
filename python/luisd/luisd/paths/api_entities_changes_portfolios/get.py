...
SchemaFor200ResponseBodyTextPlain = ResourceListOfChange
SchemaFor200ResponseBodyApplicationJson = ResourceListOfChange
SchemaFor200ResponseBodyTextJson = ResourceListOfChange
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_changes_oapg(
        self,
...
class GetPortfolioChanges(BaseApi):
    ...
    def get_portfolio_changes(
        ...
        return self._get_portfolio_changes_oapg(
