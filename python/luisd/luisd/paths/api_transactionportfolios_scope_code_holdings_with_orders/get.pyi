...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'byTaxlots': typing.Union[ByTaxlotsSchema, None, bool, ],
...
request_query_by_taxlots = api_client.QueryParameter(
    name="byTaxlots",
    style=api_client.ParameterStyle.FORM,
    schema=ByTaxlotsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = VersionedResourceListWithWarningsOfPortfolioHolding
SchemaFor200ResponseBodyApplicationJson = VersionedResourceListWithWarningsOfPortfolioHolding
SchemaFor200ResponseBodyTextJson = VersionedResourceListWithWarningsOfPortfolioHolding
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_holdings_with_orders_oapg(
        self,
...
class GetHoldingsWithOrders(BaseApi):
    ...
    def get_holdings_with_orders(
        ...
        return self._get_holdings_with_orders_oapg(
