...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfSequenceDefinition
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfSequenceDefinition
SchemaFor200ResponseBodyTextJson = PagedResourceListOfSequenceDefinition
...
class ListSequences(BaseApi):
    ...
    def list_sequences(
        ...
        return self._list_sequences_oapg(
