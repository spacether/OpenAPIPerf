...
SchemaFor200ResponseBodyTextPlain = ResourceListOfHoldingsAdjustmentHeader
SchemaFor200ResponseBodyApplicationJson = ResourceListOfHoldingsAdjustmentHeader
SchemaFor200ResponseBodyTextJson = ResourceListOfHoldingsAdjustmentHeader
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_holdings_adjustments_oapg(
        self,
...
class ListHoldingsAdjustments(BaseApi):
    ...
    def list_holdings_adjustments(
        ...
        return self._list_holdings_adjustments_oapg(
