...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'units': typing.Union[UnitsSchema, list, tuple, None, ],
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfIUnitDefinitionDto
SchemaFor200ResponseBodyApplicationJson = ResourceListOfIUnitDefinitionDto
SchemaFor200ResponseBodyTextJson = ResourceListOfIUnitDefinitionDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_units_from_data_type_oapg(
        self,
...
class GetUnitsFromDataType(BaseApi):
    ...
    def get_units_from_data_type(
        ...
        return self._get_units_from_data_type_oapg(
