...
SchemaFor200ResponseBodyTextPlain = ResourceListOfQuoteAccessMetadataRule
SchemaFor200ResponseBodyApplicationJson = ResourceListOfQuoteAccessMetadataRule
SchemaFor200ResponseBodyTextJson = ResourceListOfQuoteAccessMetadataRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_quotes_access_metadata_rules_oapg(
        self,
...
class ListQuotesAccessMetadataRules(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_quotes_access_metadata_rules(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_quotes_access_metadata_rules(
        ...
        return self._list_quotes_access_metadata_rules_oapg(
