...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateDerivedPropertyDefinitionRequest
SchemaForRequestBodyApplicationJson = CreateDerivedPropertyDefinitionRequest
SchemaForRequestBodyTextJson = CreateDerivedPropertyDefinitionRequest
SchemaForRequestBodyApplicationJson = CreateDerivedPropertyDefinitionRequest


request_body_create_derived_property_definition_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = PropertyDefinition
SchemaFor201ResponseBodyApplicationJson = PropertyDefinition
SchemaFor201ResponseBodyTextJson = PropertyDefinition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_derived_property_definition_oapg(
        self,
    ...
    def _create_derived_property_definition_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_derived_property_definition_request.serialize(body, content_type)
...
class CreateDerivedPropertyDefinition(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_derived_property_definition(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson,],
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_derived_property_definition(
        ...
        return self._create_derived_property_definition_oapg(
            body=body,
