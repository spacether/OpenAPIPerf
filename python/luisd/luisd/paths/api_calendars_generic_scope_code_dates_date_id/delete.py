...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'dateId': typing.Union[DateIdSchema, str, ],
    }
)
...
request_path_date_id = api_client.PathParameter(
    name="dateId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DateIdSchema,
    required=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_date_from_calendar_oapg(
        self,
...
class DeleteDateFromCalendar(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_date_from_calendar(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_date_from_calendar(
        ...
        return self._delete_date_from_calendar_oapg(
