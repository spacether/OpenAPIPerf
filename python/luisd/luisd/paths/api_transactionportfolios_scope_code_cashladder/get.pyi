...
# Query params
FromEffectiveAtSchema = schemas.StrSchema
ToEffectiveAtSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fromEffectiveAt': typing.Union[FromEffectiveAtSchema, str, ],
        'toEffectiveAt': typing.Union[ToEffectiveAtSchema, str, ],
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfPortfolioCashLadder
SchemaFor200ResponseBodyApplicationJson = ResourceListOfPortfolioCashLadder
SchemaFor200ResponseBodyTextJson = ResourceListOfPortfolioCashLadder
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_cash_ladder_oapg(
        self,
...
class GetPortfolioCashLadder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_portfolio_cash_ladder(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_portfolio_cash_ladder(
        ...
        return self._get_portfolio_cash_ladder_oapg(
