...
SchemaFor200ResponseBodyTextPlain = Placement
SchemaFor200ResponseBodyApplicationJson = Placement
SchemaFor200ResponseBodyTextJson = Placement
...
class GetPlacement(BaseApi):
    ...
    def get_placement(
        ...
        return self._get_placement_oapg(
