...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['SetTransactionConfigurationSourceRequest']:
...
class BaseApi(api_client.Api):
    ...
    def _set_transaction_configuration_source(
        self: api_client.Api,
...
class SetTransactionConfigurationSource(BaseApi):
    ...
    def set_transaction_configuration_source(
        ...
        return self._set_transaction_configuration_source(
            body=body,
