...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = BucketedCashFlowRequest
SchemaForRequestBodyApplicationJson = BucketedCashFlowRequest
SchemaForRequestBodyTextJson = BucketedCashFlowRequest
SchemaForRequestBodyApplicationJson = BucketedCashFlowRequest


request_body_bucketed_cash_flow_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = BucketedCashFlowResponse
SchemaFor200ResponseBodyApplicationJson = BucketedCashFlowResponse
SchemaFor200ResponseBodyTextJson = BucketedCashFlowResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_bucketed_cash_flows_oapg(
        self,
    ...
    def _get_bucketed_cash_flows_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_bucketed_cash_flow_request.serialize(body, content_type)
...
class GetBucketedCashFlows(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_bucketed_cash_flows(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def get_bucketed_cash_flows(
        ...
        return self._get_bucketed_cash_flows_oapg(
            body=body,
