...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['Operation']:
        return Operation
...
request_body_operation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_portfolio_details(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_operation.serialize(body, content_type)
...
class PatchPortfolioDetails(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def patch_portfolio_details(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, SchemaForRequestBodyApplicationJson, SchemaForRequestBodyTextJson, SchemaForRequestBodyApplicationJson],
        query_params: RequestQueryParams = frozendict(),
        path_params: RequestPathParams = frozendict(),
        ...
        return self._patch_portfolio_details(
            body=body,
