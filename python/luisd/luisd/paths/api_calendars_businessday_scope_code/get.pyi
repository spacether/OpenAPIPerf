...
request_query_date_time = api_client.QueryParameter(
    name="dateTime",
...
SchemaFor200ResponseBodyTextPlain = IsBusinessDayResponse
SchemaFor200ResponseBodyApplicationJson = IsBusinessDayResponse
SchemaFor200ResponseBodyTextJson = IsBusinessDayResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _is_business_date_time_oapg(
        self,
...
class IsBusinessDateTime(BaseApi):
    ...
    def is_business_date_time(
        ...
        return self._is_business_date_time_oapg(
