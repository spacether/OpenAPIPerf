...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfOrderGraphBlock
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfOrderGraphBlock
SchemaFor200ResponseBodyTextJson = PagedResourceListOfOrderGraphBlock
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_order_graph_blocks_oapg(
        self,
...
class ListOrderGraphBlocks(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_order_graph_blocks(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_order_graph_blocks(
        ...
        return self._list_order_graph_blocks_oapg(
