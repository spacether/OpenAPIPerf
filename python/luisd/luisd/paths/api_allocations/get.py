...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfAllocation
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfAllocation
SchemaFor200ResponseBodyTextJson = PagedResourceListOfAllocation
...
class ListAllocations(BaseApi):
    ...
    def list_allocations(
        ...
        return self._list_allocations_oapg(
