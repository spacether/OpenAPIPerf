...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = AllocationSetRequest
SchemaForRequestBodyApplicationJson = AllocationSetRequest
SchemaForRequestBodyTextJson = AllocationSetRequest
SchemaForRequestBodyApplicationJson = AllocationSetRequest


request_body_allocation_set_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfAllocation
SchemaFor200ResponseBodyApplicationJson = ResourceListOfAllocation
SchemaFor200ResponseBodyTextJson = ResourceListOfAllocation
...
class BaseApi(api_client.Api):
    ...
    def _upsert_allocations_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_allocation_set_request.serialize(body, content_type)
...
class UpsertAllocations(BaseApi):
    ...
    def upsert_allocations(
        ...
        return self._upsert_allocations_oapg(
            body=body,
