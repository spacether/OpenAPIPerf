...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfPropertyDefinitionSearchResult
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfPropertyDefinitionSearchResult
SchemaFor200ResponseBodyTextJson = PagedResourceListOfPropertyDefinitionSearchResult
...
class SearchProperties(BaseApi):
    ...
    def search_properties(
        ...
        return self._search_properties_oapg(
