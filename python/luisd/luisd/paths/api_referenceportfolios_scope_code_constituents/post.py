...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_reference_portfolio_constituents_oapg(
        self,
...
class UpsertReferencePortfolioConstituents(BaseApi):
    ...
    def upsert_reference_portfolio_constituents(
        ...
        return self._upsert_reference_portfolio_constituents_oapg(
            body=body,
