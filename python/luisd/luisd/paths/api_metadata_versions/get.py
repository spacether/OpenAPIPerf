...
SchemaFor200ResponseBodyTextPlain = VersionSummaryDto
SchemaFor200ResponseBodyApplicationJson = VersionSummaryDto
SchemaFor200ResponseBodyTextJson = VersionSummaryDto
...
class GetLusidVersions(BaseApi):
    ...
    def get_lusid_versions(
        ...
        return self._get_lusid_versions_oapg(
