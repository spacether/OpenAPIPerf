...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'asAtTime': typing.Union[AsAtTimeSchema, None, str, datetime, ],
    },
    total=False
)
...
request_query_as_at_time = api_client.QueryParameter(
    name="asAtTime",
    style=api_client.ParameterStyle.FORM,
    schema=AsAtTimeSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfConstituentsAdjustmentHeader
SchemaFor200ResponseBodyApplicationJson = ResourceListOfConstituentsAdjustmentHeader
SchemaFor200ResponseBodyTextJson = ResourceListOfConstituentsAdjustmentHeader
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_constituents_adjustments_oapg(
        self,
...
class ListConstituentsAdjustments(BaseApi):
    ...
    def list_constituents_adjustments(
        ...
        return self._list_constituents_adjustments_oapg(
