...
SchemaFor200ResponseBodyTextPlain = PortfolioGroupProperties
SchemaFor200ResponseBodyApplicationJson = PortfolioGroupProperties
SchemaFor200ResponseBodyTextJson = PortfolioGroupProperties
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_group_properties_oapg(
        self,
...
class UpsertGroupProperties(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upsert_group_properties(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def upsert_group_properties(
        ...
        return self._upsert_group_properties_oapg(
            body=body,
