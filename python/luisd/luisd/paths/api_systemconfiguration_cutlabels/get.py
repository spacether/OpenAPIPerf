...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfCutLabelDefinition
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfCutLabelDefinition
SchemaFor200ResponseBodyTextJson = PagedResourceListOfCutLabelDefinition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cut_label_definitions_oapg(
        self,
...
class ListCutLabelDefinitions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_cut_label_definitions(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_cut_label_definitions(
        ...
        return self._list_cut_label_definitions_oapg(
