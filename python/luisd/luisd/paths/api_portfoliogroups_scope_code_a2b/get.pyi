...
SchemaFor200ResponseBodyTextPlain = VersionedResourceListOfA2BDataRecord
SchemaFor200ResponseBodyApplicationJson = VersionedResourceListOfA2BDataRecord
SchemaFor200ResponseBodyTextJson = VersionedResourceListOfA2BDataRecord
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_a2_b_data_for_portfolio_group_oapg(
        self,
...
class GetA2BDataForPortfolioGroup(BaseApi):
    ...
    def get_a2_b_data_for_portfolio_group(
        ...
        return self._get_a2_b_data_for_portfolio_group_oapg(
