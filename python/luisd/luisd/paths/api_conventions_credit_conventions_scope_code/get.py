...
SchemaFor200ResponseBodyTextPlain = GetCdsFlowConventionsResponse
SchemaFor200ResponseBodyApplicationJson = GetCdsFlowConventionsResponse
SchemaFor200ResponseBodyTextJson = GetCdsFlowConventionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cds_flow_conventions_oapg(
        self,
...
class GetCdsFlowConventions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_cds_flow_conventions(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_cds_flow_conventions(
        ...
        return self._get_cds_flow_conventions_oapg(
