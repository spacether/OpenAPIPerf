...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'effectiveAt': typing.Union[EffectiveAtSchema, None, str, datetime, ],
    },
    total=False
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'subgroupScope': typing.Union[SubgroupScopeSchema, None, str, ],
        'subgroupCode': typing.Union[SubgroupCodeSchema, None, str, ],
    }
)
...
request_path_subgroup_scope = api_client.PathParameter(
    name="subgroupScope",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubgroupScopeSchema,
    required=True,
)
request_path_subgroup_code = api_client.PathParameter(
    name="subgroupCode",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubgroupCodeSchema,
    required=True,
)
SchemaFor200ResponseBodyTextPlain = PortfolioGroup
SchemaFor200ResponseBodyApplicationJson = PortfolioGroup
SchemaFor200ResponseBodyTextJson = PortfolioGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_sub_group_from_group_oapg(
        self,
    ...
    def _delete_sub_group_from_group_oapg(
        ...
        for parameter in (
            request_path_scope,
            request_path_code,
            request_path_subgroup_scope,
            request_path_subgroup_code,
        ):
...
class DeleteSubGroupFromGroup(BaseApi):
    ...
    def delete_sub_group_from_group(
        ...
        return self._delete_sub_group_from_group_oapg(
