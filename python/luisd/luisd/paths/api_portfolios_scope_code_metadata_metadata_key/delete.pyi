...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_key_from_portfolio_access_metadata_oapg(
        self,
...
class DeleteKeyFromPortfolioAccessMetadata(BaseApi):
    ...
    def delete_key_from_portfolio_access_metadata(
        ...
        return self._delete_key_from_portfolio_access_metadata_oapg(
