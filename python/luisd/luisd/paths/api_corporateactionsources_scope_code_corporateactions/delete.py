...
class CorporateActionIdsSchema(
    schemas.ListSchema
):
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'corporateActionIds': typing.Union[CorporateActionIdsSchema, list, tuple, ],
    }
)
...
request_query_corporate_action_ids = api_client.QueryParameter(
    name="corporateActionIds",
    style=api_client.ParameterStyle.FORM,
    schema=CorporateActionIdsSchema,
    required=True,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_corporate_actions_oapg(
        self,
    ...
    def _delete_corporate_actions_oapg(
        ...
        for parameter in (
            request_query_corporate_action_ids,
        ):
...
class DeleteCorporateActions(BaseApi):
    ...
    def delete_corporate_actions(
        ...
        return self._delete_corporate_actions_oapg(
