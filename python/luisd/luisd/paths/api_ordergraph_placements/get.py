...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'paginationToken': typing.Union[PaginationTokenSchema, None, str, ],
...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfOrderGraphPlacement
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfOrderGraphPlacement
SchemaFor200ResponseBodyTextJson = PagedResourceListOfOrderGraphPlacement
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_order_graph_placements_oapg(
        self,
...
class ListOrderGraphPlacements(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_order_graph_placements(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_order_graph_placements(
        ...
        return self._list_order_graph_placements_oapg(
