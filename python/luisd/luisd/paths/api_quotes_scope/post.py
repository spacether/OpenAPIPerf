...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['UpsertQuoteRequest']:
            return UpsertQuoteRequest

    
    def __getitem__(self, name: typing.Union[str, ]) -> 'UpsertQuoteRequest':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'UpsertQuoteRequest':
...
class UpsertQuotes(BaseApi):
    ...
    def upsert_quotes(
        ...
        return self._upsert_quotes_oapg(
            body=body,
