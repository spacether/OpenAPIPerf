...
SchemaFor200ResponseBodyTextPlain = ResourceListOfQuote
SchemaFor200ResponseBodyApplicationJson = ResourceListOfQuote
SchemaFor200ResponseBodyTextJson = ResourceListOfQuote
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_quotes_for_scope_oapg(
        self,
...
class ListQuotesForScope(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_quotes_for_scope(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_quotes_for_scope(
        ...
        return self._list_quotes_for_scope_oapg(
