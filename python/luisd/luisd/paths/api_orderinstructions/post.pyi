...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = OrderInstructionSetRequest
SchemaForRequestBodyApplicationJson = OrderInstructionSetRequest
SchemaForRequestBodyTextJson = OrderInstructionSetRequest
SchemaForRequestBodyApplicationJson = OrderInstructionSetRequest


request_body_order_instruction_set_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = ResourceListOfOrderInstruction
SchemaFor201ResponseBodyApplicationJson = ResourceListOfOrderInstruction
SchemaFor201ResponseBodyTextJson = ResourceListOfOrderInstruction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_order_instructions_oapg(
        self,
    ...
    def _upsert_order_instructions_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_order_instruction_set_request.serialize(body, content_type)
...
class UpsertOrderInstructions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def upsert_order_instructions(
        self,
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def upsert_order_instructions(
        ...
        return self._upsert_order_instructions_oapg(
            body=body,
