...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfOrderInstruction
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfOrderInstruction
SchemaFor200ResponseBodyTextJson = PagedResourceListOfOrderInstruction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_order_instructions_oapg(
        self,
...
class ListOrderInstructions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_order_instructions(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_order_instructions(
        ...
        return self._list_order_instructions_oapg(
