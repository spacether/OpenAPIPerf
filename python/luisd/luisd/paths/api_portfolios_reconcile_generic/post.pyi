...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = ReconciliationRequest
SchemaForRequestBodyApplicationJson = ReconciliationRequest
SchemaForRequestBodyTextJson = ReconciliationRequest
SchemaForRequestBodyApplicationJson = ReconciliationRequest


request_body_reconciliation_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ReconciliationResponse
SchemaFor200ResponseBodyApplicationJson = ReconciliationResponse
SchemaFor200ResponseBodyTextJson = ReconciliationResponse
...
class BaseApi(api_client.Api):
    ...
    def _reconcile_generic_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_reconciliation_request.serialize(body, content_type)
...
class ReconcileGeneric(BaseApi):
    ...
    def reconcile_generic(
        ...
        return self._reconcile_generic_oapg(
            body=body,
