...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfPackage
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfPackage
SchemaFor200ResponseBodyTextJson = PagedResourceListOfPackage
...
class ListPackages(BaseApi):
    ...
    def list_packages(
        ...
        return self._list_packages_oapg(
