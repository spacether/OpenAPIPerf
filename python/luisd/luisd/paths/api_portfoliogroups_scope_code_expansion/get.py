...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'propertyFilter': typing.Union[PropertyFilterSchema, list, tuple, None, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyTextPlain = ExpandedGroup
SchemaFor200ResponseBodyApplicationJson = ExpandedGroup
SchemaFor200ResponseBodyTextJson = ExpandedGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_group_expansion_oapg(
        self,
...
class GetPortfolioGroupExpansion(BaseApi):
    ...
    def get_portfolio_group_expansion(
        ...
        return self._get_portfolio_group_expansion_oapg(
