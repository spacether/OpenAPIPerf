...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fromAsAt': typing.Union[FromAsAtSchema, None, str, datetime, ],
        'toAsAt': typing.Union[ToAsAtSchema, None, str, datetime, ],
...
request_query_from_as_at = api_client.QueryParameter(
    name="fromAsAt",
    style=api_client.ParameterStyle.FORM,
    schema=FromAsAtSchema,
    explode=True,
)
request_query_to_as_at = api_client.QueryParameter(
    name="toAsAt",
    style=api_client.ParameterStyle.FORM,
    schema=ToAsAtSchema,
    explode=True,
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfProcessedCommand
SchemaFor200ResponseBodyApplicationJson = ResourceListOfProcessedCommand
SchemaFor200ResponseBodyTextJson = ResourceListOfProcessedCommand
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_group_commands_oapg(
        self,
    ...
    def _get_portfolio_group_commands_oapg(
        ...
        for parameter in (
            request_query_from_as_at,
            request_query_to_as_at,
...
class GetPortfolioGroupCommands(BaseApi):
    ...
    def get_portfolio_group_commands(
        ...
        return self._get_portfolio_group_commands_oapg(
