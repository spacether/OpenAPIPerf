...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateRecipeRequest
SchemaForRequestBodyApplicationJson = CreateRecipeRequest
SchemaForRequestBodyTextJson = CreateRecipeRequest
SchemaForRequestBodyApplicationJson = CreateRecipeRequest


request_body_create_recipe_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = ConfigurationRecipe
SchemaFor200ResponseBodyApplicationJson = ConfigurationRecipe
SchemaFor200ResponseBodyTextJson = ConfigurationRecipe
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_configuration_recipe_oapg(
        self,
    ...
    def _generate_configuration_recipe_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_recipe_request.serialize(body, content_type)
...
class GenerateConfigurationRecipe(BaseApi):
    ...
    def generate_configuration_recipe(
        ...
        return self._generate_configuration_recipe_oapg(
            body=body,
