...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = UpsertPersonRequest
SchemaForRequestBodyApplicationJson = UpsertPersonRequest
SchemaForRequestBodyTextJson = UpsertPersonRequest
SchemaForRequestBodyApplicationJson = UpsertPersonRequest


request_body_upsert_person_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = Person
SchemaFor201ResponseBodyApplicationJson = Person
SchemaFor201ResponseBodyTextJson = Person
...
class BaseApi(api_client.Api):
    ...
    def _upsert_person_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upsert_person_request.serialize(body, content_type)
...
class UpsertPerson(BaseApi):
    ...
    def upsert_person(
        ...
        return self._upsert_person_oapg(
            body=body,
