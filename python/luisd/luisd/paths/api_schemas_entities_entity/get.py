...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'entity': typing.Union[EntitySchema, None, str, ],
    }
)
...
request_path_entity = api_client.PathParameter(
    name="entity",
...
SchemaFor200ResponseBodyTextPlain = Schema
SchemaFor200ResponseBodyApplicationJson = Schema
SchemaFor200ResponseBodyTextJson = Schema
...
class GetEntitySchema(BaseApi):
    ...
    def get_entity_schema(
        ...
        return self._get_entity_schema_oapg(
