...
SchemaFor200ResponseBodyTextPlain = ResourceListOfGetCreditSupportAnnexResponse
SchemaFor200ResponseBodyApplicationJson = ResourceListOfGetCreditSupportAnnexResponse
SchemaFor200ResponseBodyTextJson = ResourceListOfGetCreditSupportAnnexResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_credit_support_annexes_oapg(
        self,
...
class ListCreditSupportAnnexes(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_credit_support_annexes(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_credit_support_annexes(
        ...
        return self._list_credit_support_annexes_oapg(
