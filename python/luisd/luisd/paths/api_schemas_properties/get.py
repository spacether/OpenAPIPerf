...
SchemaFor200ResponseBodyTextPlain = PropertySchema
SchemaFor200ResponseBodyApplicationJson = PropertySchema
SchemaFor200ResponseBodyTextJson = PropertySchema
...
class GetPropertySchema(BaseApi):
    ...
    def get_property_schema(
        ...
        return self._get_property_schema_oapg(
