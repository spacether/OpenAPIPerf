...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateDerivedTransactionPortfolioRequest
SchemaForRequestBodyApplicationJson = CreateDerivedTransactionPortfolioRequest
SchemaForRequestBodyTextJson = CreateDerivedTransactionPortfolioRequest
SchemaForRequestBodyApplicationJson = CreateDerivedTransactionPortfolioRequest


request_body_create_derived_transaction_portfolio_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = Portfolio
SchemaFor201ResponseBodyApplicationJson = Portfolio
SchemaFor201ResponseBodyTextJson = Portfolio
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_derived_portfolio_oapg(
        self,
    ...
    def _create_derived_portfolio_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_derived_transaction_portfolio_request.serialize(body, content_type)
...
class CreateDerivedPortfolio(BaseApi):
    ...
    def create_derived_portfolio(
        ...
        return self._create_derived_portfolio_oapg(
            body=body,
