...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreatePortfolioDetails
SchemaForRequestBodyApplicationJson = CreatePortfolioDetails
SchemaForRequestBodyTextJson = CreatePortfolioDetails
SchemaForRequestBodyApplicationJson = CreatePortfolioDetails


request_body_create_portfolio_details = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = PortfolioDetails
SchemaFor200ResponseBodyApplicationJson = PortfolioDetails
SchemaFor200ResponseBodyTextJson = PortfolioDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_portfolio_details_oapg(
        self,
    ...
    def _upsert_portfolio_details_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_portfolio_details.serialize(body, content_type)
...
class UpsertPortfolioDetails(BaseApi):
    ...
    def upsert_portfolio_details(
        ...
        return self._upsert_portfolio_details_oapg(
            body=body,
