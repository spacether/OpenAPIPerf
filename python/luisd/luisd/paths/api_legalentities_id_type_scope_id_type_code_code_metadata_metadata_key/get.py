...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_legal_entity_access_metadata_by_key_oapg(
        self,
...
class GetLegalEntityAccessMetadataByKey(BaseApi):
    ...
    def get_legal_entity_access_metadata_by_key(
        ...
        return self._get_legal_entity_access_metadata_by_key_oapg(
