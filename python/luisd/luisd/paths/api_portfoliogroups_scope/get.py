...
SchemaFor200ResponseBodyTextPlain = ResourceListOfPortfolioGroup
SchemaFor200ResponseBodyApplicationJson = ResourceListOfPortfolioGroup
SchemaFor200ResponseBodyTextJson = ResourceListOfPortfolioGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_portfolio_groups_oapg(
        self,
...
class ListPortfolioGroups(BaseApi):
    ...
    def list_portfolio_groups(
        ...
        return self._list_portfolio_groups_oapg(
