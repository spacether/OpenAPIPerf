...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['CreateDataMapRequest']:
            return CreateDataMapRequest
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'CreateDataMapRequest':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'CreateDataMapRequest':
...
class CreateDataMap(BaseApi):
    ...
    def create_data_map(
        ...
        return self._create_data_map_oapg(
            body=body,
