...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateDateRequest
SchemaForRequestBodyApplicationJson = CreateDateRequest
SchemaForRequestBodyTextJson = CreateDateRequest
SchemaForRequestBodyApplicationJson = CreateDateRequest


request_body_create_date_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = CalendarDate
SchemaFor200ResponseBodyApplicationJson = CalendarDate
SchemaFor200ResponseBodyTextJson = CalendarDate
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_date_to_calendar_oapg(
        self,
    ...
    def _add_date_to_calendar_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_date_request.serialize(body, content_type)
...
class AddDateToCalendar(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_date_to_calendar(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJsonPatchjson,],
        content_type: typing_extensions.Literal["application/json-patch+json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def add_date_to_calendar(
        ...
        return self._add_date_to_calendar_oapg(
            body=body,
