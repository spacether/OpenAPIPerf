...
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfComplianceRuleResult
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfComplianceRuleResult
SchemaFor200ResponseBodyTextJson = PagedResourceListOfComplianceRuleResult
...
class GetComplianceRun(BaseApi):
    ...
    def get_compliance_run(
        ...
        return self._get_compliance_run_oapg(
