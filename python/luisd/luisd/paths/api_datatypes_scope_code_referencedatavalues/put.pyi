...
request_body_field_value = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_reference_values_oapg(
        self,
    ...
    def _update_reference_values_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_field_value.serialize(body, content_type)
...
class UpdateReferenceValues(BaseApi):
    ...
    def update_reference_values(
        ...
        return self._update_reference_values_oapg(
            body=body,
