...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = UpdatePropertyDefinitionRequest
SchemaForRequestBodyApplicationJson = UpdatePropertyDefinitionRequest
SchemaForRequestBodyTextJson = UpdatePropertyDefinitionRequest
SchemaForRequestBodyApplicationJson = UpdatePropertyDefinitionRequest


request_body_update_property_definition_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = PropertyDefinition
SchemaFor200ResponseBodyApplicationJson = PropertyDefinition
SchemaFor200ResponseBodyTextJson = PropertyDefinition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_property_definition_oapg(
        self,
    ...
    def _update_property_definition_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_property_definition_request.serialize(body, content_type)
...
class UpdatePropertyDefinition(BaseApi):
    ...
    def update_property_definition(
        ...
        return self._update_property_definition_oapg(
            body=body,
