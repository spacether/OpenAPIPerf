...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'windowStart': typing.Union[WindowStartSchema, None, str, ],
        'windowEnd': typing.Union[WindowEndSchema, None, str, ],
...
request_query_window_start = api_client.QueryParameter(
    name="windowStart",
    style=api_client.ParameterStyle.FORM,
    schema=WindowStartSchema,
    explode=True,
)
request_query_window_end = api_client.QueryParameter(
    name="windowEnd",
    style=api_client.ParameterStyle.FORM,
    schema=WindowEndSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfTransaction
SchemaFor200ResponseBodyApplicationJson = ResourceListOfTransaction
SchemaFor200ResponseBodyTextJson = ResourceListOfTransaction
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_upsertable_portfolio_cash_flows_oapg(
        self,
    ...
    def _get_upsertable_portfolio_cash_flows_oapg(
        ...
        for parameter in (
            ...
            request_query_window_start,
            request_query_window_end,
            request_query_as_at,
...
class GetUpsertablePortfolioCashFlows(BaseApi):
    ...
    def get_upsertable_portfolio_cash_flows(
        ...
        return self._get_upsertable_portfolio_cash_flows_oapg(
