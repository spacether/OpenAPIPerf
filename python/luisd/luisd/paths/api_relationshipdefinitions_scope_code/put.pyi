...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = UpdateRelationshipDefinitionRequest
SchemaForRequestBodyApplicationJson = UpdateRelationshipDefinitionRequest
SchemaForRequestBodyTextJson = UpdateRelationshipDefinitionRequest
SchemaForRequestBodyApplicationJson = UpdateRelationshipDefinitionRequest


request_body_update_relationship_definition_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = RelationshipDefinition
SchemaFor200ResponseBodyApplicationJson = RelationshipDefinition
SchemaFor200ResponseBodyTextJson = RelationshipDefinition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_relationship_definition_oapg(
        self,
    ...
    def _update_relationship_definition_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_relationship_definition_request.serialize(body, content_type)
...
class UpdateRelationshipDefinition(BaseApi):
    ...
    def update_relationship_definition(
        ...
        return self._update_relationship_definition_oapg(
            body=body,
