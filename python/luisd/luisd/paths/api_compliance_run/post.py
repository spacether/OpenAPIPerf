...
SchemaFor200ResponseBodyTextPlain = ComplianceRun
SchemaFor200ResponseBodyApplicationJson = ComplianceRun
SchemaFor200ResponseBodyTextJson = ComplianceRun
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_compliance_check_oapg(
        self,
...
class RunComplianceCheck(BaseApi):
    ...
    def run_compliance_check(
        ...
        return self._run_compliance_check_oapg(
