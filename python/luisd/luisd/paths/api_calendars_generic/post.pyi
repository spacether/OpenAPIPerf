...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateCalendarRequest
SchemaForRequestBodyApplicationJson = CreateCalendarRequest
SchemaForRequestBodyTextJson = CreateCalendarRequest
SchemaForRequestBodyApplicationJson = CreateCalendarRequest


request_body_create_calendar_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = Calendar
SchemaFor200ResponseBodyApplicationJson = Calendar
SchemaFor200ResponseBodyTextJson = Calendar
...
class BaseApi(api_client.Api):
    ...
    def _create_calendar_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_calendar_request.serialize(body, content_type)
...
class CreateCalendar(BaseApi):
    ...
    def create_calendar(
        ...
        return self._create_calendar_oapg(
            body=body,
