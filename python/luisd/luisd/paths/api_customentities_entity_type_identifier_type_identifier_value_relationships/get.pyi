...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'identifierScope': typing.Union[IdentifierScopeSchema, str, ],
    }
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'identifierValue': typing.Union[IdentifierValueSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyTextPlain = ResourceListOfRelationship
SchemaFor200ResponseBodyApplicationJson = ResourceListOfRelationship
SchemaFor200ResponseBodyTextJson = ResourceListOfRelationship
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_custom_entity_relationships_oapg(
        self,
...
class GetCustomEntityRelationships(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_custom_entity_relationships(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_custom_entity_relationships(
        ...
        return self._get_custom_entity_relationships_oapg(
