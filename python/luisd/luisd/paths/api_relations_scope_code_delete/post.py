...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = DeleteRelationRequest
SchemaForRequestBodyApplicationJson = DeleteRelationRequest
SchemaForRequestBodyTextJson = DeleteRelationRequest
SchemaForRequestBodyApplicationJson = DeleteRelationRequest


request_body_delete_relation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_relation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_delete_relation_request.serialize(body, content_type)
...
class DeleteRelation(BaseApi):
    ...
    def delete_relation(
        ...
        return self._delete_relation_oapg(
            body=body,
