...
request_body_performance_return = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = UpsertReturnsResponse
SchemaFor200ResponseBodyApplicationJson = UpsertReturnsResponse
SchemaFor200ResponseBodyTextJson = UpsertReturnsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upsert_portfolio_returns_oapg(
        self,
    ...
    def _upsert_portfolio_returns_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_performance_return.serialize(body, content_type)
...
class UpsertPortfolioReturns(BaseApi):
    ...
    def upsert_portfolio_returns(
        ...
        return self._upsert_portfolio_returns_oapg(
            body=body,
