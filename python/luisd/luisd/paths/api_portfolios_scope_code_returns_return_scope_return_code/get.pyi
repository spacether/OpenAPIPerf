...
SchemaFor200ResponseBodyTextPlain = ResourceListOfPerformanceReturn
SchemaFor200ResponseBodyApplicationJson = ResourceListOfPerformanceReturn
SchemaFor200ResponseBodyTextJson = ResourceListOfPerformanceReturn
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_returns_oapg(
        self,
...
class GetPortfolioReturns(BaseApi):
    ...
    def get_portfolio_returns(
        ...
        return self._get_portfolio_returns_oapg(
