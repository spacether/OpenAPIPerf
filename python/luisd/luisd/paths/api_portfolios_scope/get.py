...
SchemaFor200ResponseBodyTextPlain = ResourceListOfPortfolio
SchemaFor200ResponseBodyApplicationJson = ResourceListOfPortfolio
SchemaFor200ResponseBodyTextJson = ResourceListOfPortfolio
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_portfolios_for_scope_oapg(
        self,
...
class ListPortfoliosForScope(BaseApi):
    ...
    def list_portfolios_for_scope(
        ...
        return self._list_portfolios_for_scope_oapg(
