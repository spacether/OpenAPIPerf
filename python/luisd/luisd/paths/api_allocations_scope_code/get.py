...
SchemaFor200ResponseBodyTextPlain = Allocation
SchemaFor200ResponseBodyApplicationJson = Allocation
SchemaFor200ResponseBodyTextJson = Allocation
...
class GetAllocation(BaseApi):
    ...
    def get_allocation(
        ...
        return self._get_allocation_oapg(
