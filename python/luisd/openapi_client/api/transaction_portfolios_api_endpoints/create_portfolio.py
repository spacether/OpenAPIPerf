...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateTransactionPortfolioRequest
SchemaForRequestBodyApplicationJson = CreateTransactionPortfolioRequest
SchemaForRequestBodyTextJson = CreateTransactionPortfolioRequest
SchemaForRequestBodyApplicationJson = CreateTransactionPortfolioRequest


request_body_create_transaction_portfolio_request = api_client.RequestBody(
    content={
...
_path = '/api/transactionportfolios/{scope}'
_method = 'POST'
_auth = [
    'oauth2',
]
...
class CreatePortfolio(api_client.Api):
    ...
    def create_portfolio(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_transaction_portfolio_request.serialize(body, content_type)
