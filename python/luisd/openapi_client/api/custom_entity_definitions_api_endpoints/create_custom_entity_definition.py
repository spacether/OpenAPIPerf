...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CustomEntityDefinitionRequest
SchemaForRequestBodyApplicationJson = CustomEntityDefinitionRequest
SchemaForRequestBodyTextJson = CustomEntityDefinitionRequest
SchemaForRequestBodyApplicationJson = CustomEntityDefinitionRequest


request_body_custom_entity_definition_request = api_client.RequestBody(
    content={
...
_path = '/api/customentities/entitytypes'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = CustomEntityDefinition
SchemaFor200ResponseBodyApplicationJson = CustomEntityDefinition
SchemaFor200ResponseBodyTextJson = CustomEntityDefinition
...
class CreateCustomEntityDefinition(api_client.Api):

    def create_custom_entity_definition(
        self: api_client.Api,
        ...
        if body is not unset:
            serialized_data = request_body_custom_entity_definition_request.serialize(body, content_type)
