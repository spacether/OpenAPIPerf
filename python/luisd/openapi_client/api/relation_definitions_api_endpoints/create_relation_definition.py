...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateRelationDefinitionRequest
SchemaForRequestBodyApplicationJson = CreateRelationDefinitionRequest
SchemaForRequestBodyTextJson = CreateRelationDefinitionRequest
SchemaForRequestBodyApplicationJson = CreateRelationDefinitionRequest


request_body_create_relation_definition_request = api_client.RequestBody(
    content={
...
_path = '/api/relationdefinitions'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor201ResponseBodyTextPlain = RelationDefinition
SchemaFor201ResponseBodyApplicationJson = RelationDefinition
SchemaFor201ResponseBodyTextJson = RelationDefinition
...
class CreateRelationDefinition(api_client.Api):
    ...
    def create_relation_definition(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_relation_definition_request.serialize(body, content_type)
