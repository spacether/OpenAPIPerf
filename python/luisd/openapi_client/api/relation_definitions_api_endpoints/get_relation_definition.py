...
_path = '/api/relationdefinitions/{scope}/{code}'
_method = 'GET'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = RelationDefinition
SchemaFor200ResponseBodyApplicationJson = RelationDefinition
SchemaFor200ResponseBodyTextJson = RelationDefinition
...
class GetRelationDefinition(api_client.Api):
