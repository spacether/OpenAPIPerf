...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = PlacementSetRequest
SchemaForRequestBodyApplicationJson = PlacementSetRequest
SchemaForRequestBodyTextJson = PlacementSetRequest
SchemaForRequestBodyApplicationJson = PlacementSetRequest


request_body_placement_set_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = ResourceListOfPlacement
SchemaFor201ResponseBodyApplicationJson = ResourceListOfPlacement
SchemaFor201ResponseBodyTextJson = ResourceListOfPlacement
...
class UpsertPlacements(api_client.Api):

    def upsert_placements(
        self: api_client.Api,
        ...
        if body is not unset:
            serialized_data = request_body_placement_set_request.serialize(body, content_type)
