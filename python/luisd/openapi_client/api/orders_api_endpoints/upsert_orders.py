...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = OrderSetRequest
SchemaForRequestBodyApplicationJson = OrderSetRequest
SchemaForRequestBodyTextJson = OrderSetRequest
SchemaForRequestBodyApplicationJson = OrderSetRequest


request_body_order_set_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyTextPlain = ResourceListOfOrder
SchemaFor201ResponseBodyApplicationJson = ResourceListOfOrder
SchemaFor201ResponseBodyTextJson = ResourceListOfOrder
...
class UpsertOrders(api_client.Api):
    ...
    def upsert_orders(
        ...
        if body is not unset:
            serialized_data = request_body_order_set_request.serialize(body, content_type)
