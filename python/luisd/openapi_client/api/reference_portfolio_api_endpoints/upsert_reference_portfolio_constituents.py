...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = UpsertReferencePortfolioConstituentsRequest
SchemaForRequestBodyApplicationJson = UpsertReferencePortfolioConstituentsRequest
SchemaForRequestBodyTextJson = UpsertReferencePortfolioConstituentsRequest
SchemaForRequestBodyApplicationJson = UpsertReferencePortfolioConstituentsRequest


request_body_upsert_reference_portfolio_constituents_request = api_client.RequestBody(
    content={
...
_path = '/api/referenceportfolios/{scope}/{code}/constituents'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = UpsertReferencePortfolioConstituentsResponse
SchemaFor200ResponseBodyApplicationJson = UpsertReferencePortfolioConstituentsResponse
SchemaFor200ResponseBodyTextJson = UpsertReferencePortfolioConstituentsResponse
...
class UpsertReferencePortfolioConstituents(api_client.Api):
    ...
    def upsert_reference_portfolio_constituents(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upsert_reference_portfolio_constituents_request.serialize(body, content_type)
