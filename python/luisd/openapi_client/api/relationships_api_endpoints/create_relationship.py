...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = CreateRelationshipRequest
SchemaForRequestBodyApplicationJson = CreateRelationshipRequest
SchemaForRequestBodyTextJson = CreateRelationshipRequest
SchemaForRequestBodyApplicationJson = CreateRelationshipRequest


request_body_create_relationship_request = api_client.RequestBody(
    content={
...
_path = '/api/relationshipdefinitions/{scope}/{code}/relationships'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor201ResponseBodyTextPlain = CompleteRelationship
SchemaFor201ResponseBodyApplicationJson = CompleteRelationship
SchemaFor201ResponseBodyTextJson = CompleteRelationship
...
class CreateRelationship(api_client.Api):
    ...
    def create_relationship(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_relationship_request.serialize(body, content_type)
