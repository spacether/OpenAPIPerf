...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = DeleteRelationshipRequest
SchemaForRequestBodyApplicationJson = DeleteRelationshipRequest
SchemaForRequestBodyTextJson = DeleteRelationshipRequest
SchemaForRequestBodyApplicationJson = DeleteRelationshipRequest


request_body_delete_relationship_request = api_client.RequestBody(
    content={
...
_path = '/api/relationshipdefinitions/{scope}/{code}/relationships/$delete'
_method = 'POST'
_auth = [
    'oauth2',
]
...
class DeleteRelationship(api_client.Api):
    ...
    def delete_relationship(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_delete_relationship_request.serialize(body, content_type)
