...
_path = '/api/unitresults/{scope}/$get'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = GetStructuredResultDataResponse
SchemaFor200ResponseBodyApplicationJson = GetStructuredResultDataResponse
SchemaFor200ResponseBodyTextJson = GetStructuredResultDataResponse
...
class GetStructuredResultData(api_client.Api):
