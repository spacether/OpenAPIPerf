...
_path = '/api/unitresults/virtualdocument/{scope}/$get'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = GetVirtualDocumentResponse
SchemaFor200ResponseBodyApplicationJson = GetVirtualDocumentResponse
SchemaFor200ResponseBodyTextJson = GetVirtualDocumentResponse
...
class GetVirtualDocument(api_client.Api):
