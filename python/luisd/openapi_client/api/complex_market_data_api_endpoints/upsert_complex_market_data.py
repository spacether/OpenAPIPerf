...
class SchemaForRequestBodyApplicationJsonPatchjson(
    ...
    @classmethod
    @property
    def _additional_properties(cls) -> typing.Type['UpsertComplexMarketDataRequest']:
...
_path = '/api/complexmarketdata/{scope}'
_method = 'POST'
_auth = [
    'oauth2',
]
...
class UpsertComplexMarketData(api_client.Api):
