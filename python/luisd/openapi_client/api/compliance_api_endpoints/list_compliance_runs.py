...
_path = '/api/compliance'
_method = 'GET'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = PagedResourceListOfComplianceRun
SchemaFor200ResponseBodyApplicationJson = PagedResourceListOfComplianceRun
SchemaFor200ResponseBodyTextJson = PagedResourceListOfComplianceRun
...
class ListComplianceRuns(api_client.Api):
