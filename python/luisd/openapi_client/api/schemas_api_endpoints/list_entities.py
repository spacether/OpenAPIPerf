...
_path = '/api/schemas/entities'
_method = 'GET'
_auth = [
    'oauth2',
]
SchemaFor200ResponseBodyTextPlain = ResourceListOfString
SchemaFor200ResponseBodyApplicationJson = ResourceListOfString
SchemaFor200ResponseBodyTextJson = ResourceListOfString
...
class ListEntities(api_client.Api):
