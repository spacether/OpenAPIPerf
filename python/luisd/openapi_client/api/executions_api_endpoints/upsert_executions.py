...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = ExecutionSetRequest
SchemaForRequestBodyApplicationJson = ExecutionSetRequest
SchemaForRequestBodyTextJson = ExecutionSetRequest
SchemaForRequestBodyApplicationJson = ExecutionSetRequest


request_body_execution_set_request = api_client.RequestBody(
    content={
...
_path = '/api/executions'
_method = 'POST'
_auth = [
    'oauth2',
]
SchemaFor201ResponseBodyTextPlain = ResourceListOfExecution
SchemaFor201ResponseBodyApplicationJson = ResourceListOfExecution
SchemaFor201ResponseBodyTextJson = ResourceListOfExecution
...
class UpsertExecutions(api_client.Api):
    ...
    def upsert_executions(
        ...
        if body is not unset:
            serialized_data = request_body_execution_set_request.serialize(body, content_type)
