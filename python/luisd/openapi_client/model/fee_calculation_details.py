...
class FeeCalculationDetails(
    ...
    propertyKey = StrSchema

    @classmethod
    @property
    def fee(cls) -> typing.Type['CalculationInfo']:
        return CalculationInfo

    @classmethod
    @property
    def maxFee(cls) -> typing.Type['CalculationInfo']:
        return CalculationInfo

    @classmethod
    @property
    def minFee(cls) -> typing.Type['CalculationInfo']:
        return CalculationInfo
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        fee: fee,
        maxFee: typing.Union['CalculationInfo', Unset] = unset,
        minFee: typing.Union['CalculationInfo', Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
