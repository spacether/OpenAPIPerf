...
class CalendarDate(
    ...
    dateIdentifier = StrSchema
    fromUtc = DateTimeSchema
    toUtc = DateTimeSchema
    localDate = StrSchema
    timezone = StrSchema
    ...
    @classmethod
    @property
    def attributes(cls) -> typing.Type['DateAttributes']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        attributes: typing.Union['DateAttributes', Unset] = unset,
        sourceData: typing.Union[sourceData, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'CalendarDate':
        return super().__new__(
            cls,
