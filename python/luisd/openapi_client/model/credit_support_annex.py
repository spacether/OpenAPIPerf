...
that is in place between the two counterparties.
    ...
    class valuationAgent(
        ...
        pass
    thresholdAmount = Float64Schema
    roundingDecimalPlaces = Int32Schema
    initialMarginAmount = Float64Schema
    minimumTransferAmount = Float64Schema
