...
class OrderRequest(
    ...
    @classmethod
    @property
    def orderBookId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    @classmethod
    @property
    def orderInstruction(cls) -> typing.Type['ResourceId']:
        return ResourceId

    @classmethod
    @property
    def package(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        orderBookId: typing.Union['ResourceId', Unset] = unset,
        state: typing.Union[state, Unset] = unset,
        type: typing.Union[type, Unset] = unset,
        timeInForce: typing.Union[timeInForce, Unset] = unset,
        date: typing.Union[date, Unset] = unset,
        price: typing.Union['CurrencyAndAmount', Unset] = unset,
        orderInstruction: typing.Union['ResourceId', Unset] = unset,
        package: typing.Union['ResourceId', Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'OrderRequest':
        return super().__new__(
            cls,
