...
class CompleteRelationship(
    ...
    @classmethod
    @property
    def relationshipDefinitionId(cls) -> typing.Type['ResourceId']:
        return ResourceId

    @classmethod
    @property
    def sourceEntity(cls) -> typing.Type['RelatedEntity']:
        return RelatedEntity

    @classmethod
    @property
    def targetEntity(cls) -> typing.Type['RelatedEntity']:
        return RelatedEntity
    outwardDescription = StrSchema
    inwardDescription = StrSchema
