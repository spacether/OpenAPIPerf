...
class CorporateActionTransitionRequest(
    ...
    @classmethod
    @property
    def inputTransition(cls) -> typing.Type['CorporateActionTransitionComponentRequest']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        inputTransition: typing.Union['CorporateActionTransitionComponentRequest', Unset] = unset,
        outputTransitions: typing.Union[outputTransitions, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
