...
class AggregatedReturn(
    ...
    class metricsValue(
        ...
        _additional_properties = Float64Schema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        openingMarketValue: typing.Union[openingMarketValue, Unset] = unset,
        closingMarketValue: typing.Union[closingMarketValue, Unset] = unset,
        frequency: typing.Union[frequency, Unset] = unset,
        compositeMembers: typing.Union[compositeMembers, Unset] = unset,
        compositeMembersWithoutReturn: typing.Union[compositeMembersWithoutReturn, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'AggregatedReturn':
        return super().__new__(
            cls,
