...
class Placement(
    ...
    class blockIds(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['ResourceId']:
            return ResourceId
    ...
    quantity = Float64Schema
    state = StrSchema
    side = StrSchema
    timeInForce = StrSchema
    type = StrSchema
    createdDate = DateTimeSchema

    @classmethod
    @property
    def limitPrice(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount

    @classmethod
    @property
    def stopPrice(cls) -> typing.Type['CurrencyAndAmount']:
        return CurrencyAndAmount
    counterparty = StrSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        limitPrice: typing.Union['CurrencyAndAmount', Unset] = unset,
        stopPrice: typing.Union['CurrencyAndAmount', Unset] = unset,
