...
class ValuationSchedule(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        effectiveFrom: typing.Union[effectiveFrom, Unset] = unset,
        tenor: typing.Union[tenor, Unset] = unset,
        rollConvention: typing.Union[rollConvention, Unset] = unset,
        holidayCalendars: typing.Union[holidayCalendars, Unset] = unset,
        valuationDateTimes: typing.Union[valuationDateTimes, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'ValuationSchedule':
        return super().__new__(
            cls,
