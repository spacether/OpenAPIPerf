...
class GetCounterpartyAgreementResponse(
    ...
    @classmethod
    @property
    def value(cls) -> typing.Type['CounterpartyAgreement']:
    ...
    class failed(
        ...
        @classmethod
        @property
        def _additional_properties(cls) -> typing.Type['ErrorDetail']:
            return ErrorDetail
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        value: typing.Union['CounterpartyAgreement', Unset] = unset,
        failed: typing.Union[failed, Unset] = unset,
