...
class BondAllOf(
    ...
    @classmethod
    @property
    def flowConventions(cls) -> typing.Type['FlowConventions']:
        return FlowConventions
    principal = Float64Schema
    couponRate = Float64Schema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        identifiers: typing.Union[identifiers, Unset] = unset,
        exDividendDays: typing.Union[exDividendDays, Unset] = unset,
        initialCouponDate: typing.Union[initialCouponDate, Unset] = unset,
        firstCouponPayDate: typing.Union[firstCouponPayDate, Unset] = unset,
        calculationType: typing.Union[calculationType, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
        **kwargs: typing.Type[Schema],
    ) -> 'BondAllOf':
        return super().__new__(
