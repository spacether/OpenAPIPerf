...
class CorporateAction(
    ...
    announcementDate = DateTimeSchema
    exDate = DateTimeSchema
    recordDate = DateTimeSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        announcementDate: typing.Union[announcementDate, Unset] = unset,
        exDate: typing.Union[exDate, Unset] = unset,
        recordDate: typing.Union[recordDate, Unset] = unset,
        paymentDate: typing.Union[paymentDate, Unset] = unset,
        transitions: typing.Union[transitions, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'CorporateAction':
        return super().__new__(
            cls,
