...
class PerformanceReturnsMetric(
    ...
    allowPartial = BoolSchema
    annualised = BoolSchema
    withFee = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        window: typing.Union[window, Unset] = unset,
        allowPartial: typing.Union[allowPartial, Unset] = unset,
        annualised: typing.Union[annualised, Unset] = unset,
        withFee: typing.Union[withFee, Unset] = unset,
        seedAmount: typing.Union[seedAmount, Unset] = unset,
        alias: typing.Union[alias, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
