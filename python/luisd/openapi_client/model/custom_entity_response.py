...
class CustomEntityResponse(
    ...
    entityType = StrSchema
    customEntityId = StrSchema
    ...
    class identifiers(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['CustomEntityIdResponse']:
    ...
    class fields(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['CustomEntityField']:
            return CustomEntityField

    @classmethod
    @property
    def effectiveRange(cls) -> typing.Type['DateRange']:
        return DateRange

    @classmethod
    @property
    def asAtRange(cls) -> typing.Type['DateRange']:
        return DateRange
