...
class EquitySwapAllOf(
    ...
    @classmethod
    @property
    def equityFlowConventions(cls) -> typing.Type['FlowConventions']:
        return FlowConventions

    @classmethod
    @property
    def fundingLeg(cls) -> typing.Type['InstrumentLeg']:
        return InstrumentLeg
    includeDividends = BoolSchema
    initialPrice = Float64Schema
    notionalReset = BoolSchema
    quantity = Float64Schema
    underlyingIdentifier = StrSchema
