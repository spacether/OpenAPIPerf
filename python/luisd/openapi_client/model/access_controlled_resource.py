...
class AccessControlledResource(
    ...
    class actions(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['AccessControlledAction']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        actions: actions,
        application: typing.Union[application, Unset] = unset,
        name: typing.Union[name, Unset] = unset,
        identifierParts: typing.Union[identifierParts, Unset] = unset,
