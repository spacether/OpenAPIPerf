...
class PropertyValue(
    ...
    @classmethod
    @property
    def metricValue(cls) -> typing.Type['MetricValue']:
        return MetricValue

    @classmethod
    @property
    def labelValueSet(cls) -> typing.Type['LabelValueSet']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        labelValue: typing.Union[labelValue, Unset] = unset,
        metricValue: typing.Union['MetricValue', Unset] = unset,
        labelValueSet: typing.Union['LabelValueSet', Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
    ) -> 'PropertyValue':
        return super().__new__(
            cls,
