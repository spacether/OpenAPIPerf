...
class LegalEntity(
    ...
    @classmethod
    @property
    def counterpartyRiskInformation(cls) -> typing.Type['CounterpartyRiskInformation']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        lusidLegalEntityId: typing.Union[lusidLegalEntityId, Unset] = unset,
        identifiers: typing.Union[identifiers, Unset] = unset,
        properties: typing.Union[properties, Unset] = unset,
        counterpartyRiskInformation: typing.Union['CounterpartyRiskInformation', Unset] = unset,
