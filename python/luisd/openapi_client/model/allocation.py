...
Order.
    ...
    @classmethod
    @property
    def id(cls) -> typing.Type['ResourceId']:
        return ResourceId

    @classmethod
    @property
    def allocatedOrderId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    @classmethod
    @property
    def version(cls) -> typing.Type['Version']:
        return Version
    ...
    @classmethod
    @property
    def price(cls) -> typing.Type['CurrencyAndAmount']:
    ...
    settlementCurrencyFxRate = Float64Schema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        placementIds: typing.Union[placementIds, Unset] = unset,
        state: typing.Union[state, Unset] = unset,
        side: typing.Union[side, Unset] = unset,
        ...
        price: typing.Union['CurrencyAndAmount', Unset] = unset,
        settlementCurrency: typing.Union[settlementCurrency, Unset] = unset,
        settlementCurrencyFxRate: typing.Union[settlementCurrencyFxRate, Unset] = unset,
        counterparty: typing.Union[counterparty, Unset] = unset,
