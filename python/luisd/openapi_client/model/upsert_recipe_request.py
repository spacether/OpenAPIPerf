...
class UpsertRecipeRequest(
    ...
    A recipe or recipe snippet that is to be stored in the recipe structured data store.
Only one of these must be present.
    """

    @classmethod
    @property
    def configurationRecipe(cls) -> typing.Type['ConfigurationRecipe']:
        return ConfigurationRecipe

    @classmethod
    @property
    def configurationRecipeSnippet(cls) -> typing.Type['ConfigurationRecipeSnippet']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        configurationRecipe: typing.Union['ConfigurationRecipe', Unset] = unset,
        configurationRecipeSnippet: typing.Union['ConfigurationRecipeSnippet', Unset] = unset,
