...
and a <seealso cref="T:Finbourne.WebApi.Interface.Dto.ComplexMarketData.ComplexMarketDataId" /> object identifying the market data in that scope.
    ...
    @classmethod
    @property
    def marketDataId(cls) -> typing.Type['ComplexMarketDataId']:
        return ComplexMarketDataId

    @classmethod
    @property
    def marketData(cls) -> typing.Type['ComplexMarketData']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        marketDataId: typing.Union['ComplexMarketDataId', Unset] = unset,
        marketData: typing.Union['ComplexMarketData', Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
