...
class InstrumentDefinition(
    ...
    class identifiers(
        ...
        @classmethod
        @property
        def _additional_properties(cls) -> typing.Type['InstrumentIdValue']:
    ...
    @classmethod
    @property
    def lookThroughPortfolioId(cls) -> typing.Type['ResourceId']:
        return ResourceId

    @classmethod
    @property
    def definition(cls) -> typing.Type['LusidInstrument']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        lookThroughPortfolioId: typing.Union['ResourceId', Unset] = unset,
        definition: typing.Union['LusidInstrument', Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
