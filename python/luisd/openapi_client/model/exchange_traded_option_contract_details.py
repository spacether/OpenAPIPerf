...
There is a lot of overlap with this and FuturesContractDetails but as that is an established DTO we must duplicate a number of fields here
    ...
    domCcy = StrSchema
    strike = Float64Schema
    contractSize = Float64Schema
    country = StrSchema
    deliveryType = StrSchema
    description = StrSchema
    exchangeCode = StrSchema
    exerciseDate = DateTimeSchema
    exerciseType = StrSchema
    optionCode = StrSchema
    optionType = StrSchema

    @classmethod
    @property
    def underlying(cls) -> typing.Type['LusidInstrument']:
        return LusidInstrument
    underlyingCode = StrSchema
