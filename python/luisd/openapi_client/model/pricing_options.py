...
class PricingOptions(
    ...
    @classmethod
    @property
    def modelSelection(cls) -> typing.Type['ModelSelection']:
        return ModelSelection
    useInstrumentTypeToDeterminePricer = BoolSchema
    allowAnyInstrumentsWithSecUidToPriceOffLookup = BoolSchema
    allowPartiallySuccessfulEvaluation = BoolSchema
    produceSeparateResultForLinearOtcLegs = BoolSchema
    enableUseOfCachedUnitResults = BoolSchema
    windowValuationOnInstrumentStartEnd = BoolSchema
    removeContingentCashflowsInPaymentDiary = BoolSchema
    useChildSubHoldingKeysForPortfolioExpansion = BoolSchema
    validateDomesticAndQuoteCurrenciesAreConsistent = BoolSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        modelSelection: typing.Union['ModelSelection', Unset] = unset,
        useInstrumentTypeToDeterminePricer: typing.Union[useInstrumentTypeToDeterminePricer, Unset] = unset,
        allowAnyInstrumentsWithSecUidToPriceOffLookup: typing.Union[allowAnyInstrumentsWithSecUidToPriceOffLookup, Unset] = unset,
        allowPartiallySuccessfulEvaluation: typing.Union[allowPartiallySuccessfulEvaluation, Unset] = unset,
        produceSeparateResultForLinearOtcLegs: typing.Union[produceSeparateResultForLinearOtcLegs, Unset] = unset,
        enableUseOfCachedUnitResults: typing.Union[enableUseOfCachedUnitResults, Unset] = unset,
        windowValuationOnInstrumentStartEnd: typing.Union[windowValuationOnInstrumentStartEnd, Unset] = unset,
        removeContingentCashflowsInPaymentDiary: typing.Union[removeContingentCashflowsInPaymentDiary, Unset] = unset,
        useChildSubHoldingKeysForPortfolioExpansion: typing.Union[useChildSubHoldingKeysForPortfolioExpansion, Unset] = unset,
        validateDomesticAndQuoteCurrenciesAreConsistent: typing.Union[validateDomesticAndQuoteCurrenciesAreConsistent, Unset] = unset,
