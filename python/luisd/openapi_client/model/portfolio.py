...
class Portfolio(
    ...
    class type(
        ...
        @property
        def REFERENCE(cls):
            return cls._enum_by_value["Reference"]("Reference")
        
        @classmethod
        @property
        def DERIVEDTRANSACTION(cls):
            return cls._enum_by_value["DerivedTransaction"]("DerivedTransaction")
    ...
    @classmethod
    @property
    def parentPortfolioId(cls) -> typing.Type['ResourceId']:
        return ResourceId
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        parentPortfolioId: typing.Union['ResourceId', Unset] = unset,
        version: typing.Union['Version', Unset] = unset,
        isDerived: typing.Union[isDerived, Unset] = unset,
        baseCurrency: typing.Union[baseCurrency, Unset] = unset,
